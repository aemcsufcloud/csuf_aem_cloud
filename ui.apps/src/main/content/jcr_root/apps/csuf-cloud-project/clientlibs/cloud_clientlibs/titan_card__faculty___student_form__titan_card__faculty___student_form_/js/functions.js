...
/**
 * @function titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_ItTitanCardStaffSignatureCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_ItTitanCardStaffSignatureCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToITTitanCardStaff") {
    if (this.value == 1) {
...
/**
 * @function titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1666253768280_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1666253768280_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToITAVPStaff") {
    if (this.value == 1) {
...
/**
 * @function titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1666257180468_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1666257180468_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToASCStaff") {
    if (this.value == 1) {
...
/**
 * @function titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1670312823920_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_checkbox1670312823920_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToASCStaffTwo") {
    if (this.value == 1) {
...
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_WorkflowInstanceID_init0 = function (scope) {
	...
	//if(this.value !== null){
		var instance = this.value;
  		var adobeSignDocumentName = 'TitanCard_Closed_Account_Adobe_Sign.pdf';		
...
titan_card__faculty___student_form__titan_card__faculty___student_form_.generated_submit1607673526985_click0 = function (scope) {
  ...
  documentNameForAdobeSign.value = "TitanCard Closed Account Form";
}
