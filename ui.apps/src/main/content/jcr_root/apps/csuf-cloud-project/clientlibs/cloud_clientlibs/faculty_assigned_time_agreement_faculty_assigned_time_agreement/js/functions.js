...
faculty_assigned_time_agreement_faculty_assigned_time_agreement.generated_CWID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (this.value !== null && (CWID.value !== this.value) && StageIndicator.value === null) {
    var gifModal = document.getElementById('gifModal');
    gifModal.style.display = "block";
...
/**
 * @function faculty_assigned_time_agreement_faculty_assigned_time_agreement.generated_HiddenPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
faculty_assigned_time_agreement_faculty_assigned_time_agreement.generated_HiddenPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
