...
/**
 * @function parent_statement_of_non_support_parent_statement_of_non_support.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_statement_of_non_support_parent_statement_of_non_support.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    $.ajax({
...
function aidYearPopup() {
    ...
    document.getElementById("button1").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = prefixVal+"PNSP";
        formCodeVal = prefixVal+"PNSP";
        getFAFSAFinancialAidYear(aidYearValue);
...
function getFAFSAFinancialAidYear(financialAidYear) {
  ...
  var headingTextVal = "<p><b>PARENT STATEMENT OF NON-SUPPORT ".concat(" (" + financialAidYearVal + ")</b></p>");
...
if(StageIndicator.value === null){
  ...
  EmailSubject.value = "Parent Statement of Non-Support - " + cwid.value;
}
  ...
  documentNameForAdobeSign.value = "Parent Statement of Non-Support - "+formCode.value;
