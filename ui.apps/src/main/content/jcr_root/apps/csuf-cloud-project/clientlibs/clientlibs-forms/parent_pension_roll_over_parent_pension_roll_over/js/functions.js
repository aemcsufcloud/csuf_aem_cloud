...
/**
 * @function parent_pension_roll_over_parent_pension_roll_over.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_pension_roll_over_parent_pension_roll_over.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            var flag;
if (StageIndicator.value === null) {
...
function aidYearPopup() {
    ...
    document.getElementById("button1").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FinAidYearFormCodeOne+"PROP";
        formCodeVal = financialAidvalues.FinAidYearFormCodeOne+"PROP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    };
    ...
    document.getElementById("button2").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value =financialAidvalues.FinAidYearFormCodeTwo+"PROP";
        formCodeVal = financialAidvalues.FinAidYearFormCodeTwo+"PROP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    };
}
...
function singleAidYear() {
   ...
   var financialAidvalues = getAidYearValuesOnSingleAidYear();  
    ...
    if (typeOfAidYear == '0') {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FormCodeGeneral+"PROP";
        formCodeVal = financialAidvalues.FormCodeGeneral+"PROP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    }
...
parent_pension_roll_over_parent_pension_roll_over.generated_submit1575264176703_click0 = function (scope) {
  ...
  EmailSubject.value = "Parent Pension Roll Over - "+cwid.value;
  documentNameForAdobeSign.value = " Parent Pension Roll Over - "+formCode.value;
