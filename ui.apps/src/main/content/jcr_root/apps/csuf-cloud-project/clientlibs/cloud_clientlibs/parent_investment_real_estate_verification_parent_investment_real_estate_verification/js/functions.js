...
/**
 * @function parent_investment_real_estate_verification_parent_investment_real_estate_verification.generated_button_5562233861672745880190_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_investment_real_estate_verification_parent_investment_real_estate_verification.generated_button_5562233861672745880190_click0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (AidYear.value !== null) {
...
if(AidYear.value == "2022"){
    documentNameForAdobeSign.value = "Parent Investment/Real Estate Verification - F0REVP";
  }else if(AidYear.value == "2023"){
    documentNameForAdobeSign.value = "Parent Investment/Real Estate Verification - F1REVP";
  }
}
