    ...
    $.ajax({
        ...
        success: function(response) {
           ...
           // var userValue = 'veronica.maciel';	 	  	// two Aid Year
            ...
            var userValue = 'ankchinen';			 	// no Aid Year
...
/**
 * @function citizenship_verification_citizenship_verification.generated_Date_1_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
citizenship_verification_citizenship_verification.generated_Date_1_init1 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if(StageIndicator.value === null){
