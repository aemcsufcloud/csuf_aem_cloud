...
function getCDAFinancialAidYear(financialAidYear) {
  ...
  var summerTextVal = "<p><u>".concat(SummerYearChange).concat("</u></p>");
  ...
  if (AidYear.value == "2025"){
    PlusApplicationDeadlineText.visible = true;
    ApplicationProcessText.visible = true;
    textdraw_3676043771660117938264.visible = false;
    HSWithParentsCB.visible = false;
    textdraw_4160087511660122517815.visible = false;
    HSOnCampusCB.visible = false;
    textdraw_13810297481660122527806.visible = false;
    HSOffCampusCB.visible = false;
    textdraw_4726966961660122537383.visible = false;
    textdraw_20430879201660120005087.visible = false;
    
    textdraw1660668649579.visible = false;
    textdraw_2494758271659953838407.visible = false;
  } else {
    PlusApplicationDeadlineText.visible = false;
    ApplicationProcessText.visible = false;
  }
...
if(StageIndicator.value === null){
  ...
  EmailSubject.value = "Test - Adobe Sign Test - Federal Direct Plus Application - "+cwid.value;
  documentNameForAdobeSign.value = "Test - Adobe Sign Test - Federal Direct Plus Application - " + formCode.value;
}
