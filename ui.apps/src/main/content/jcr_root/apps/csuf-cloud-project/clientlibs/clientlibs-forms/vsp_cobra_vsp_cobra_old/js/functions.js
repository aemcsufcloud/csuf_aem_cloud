/**
 * @function vsp_cobra_vsp_cobra_old.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            var userID = "rpurohit";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_textdraw1575095828043_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_textdraw1575095828043_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible= false;
        }
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Disabledonthedateofqualifyingevent_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Disabledonthedateofqualifyingevent_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  //this.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Reductionofhours_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Reductionofhours_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Legalseparationordivorse_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Legalseparationordivorse_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Retiree_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Retiree_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_DissolutionofRegisteredDomesticPartnership_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_DissolutionofRegisteredDomesticPartnership_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_SurvivingDependentsWidow_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_SurvivingDependentsWidow_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Lossofchildsdependentstatus_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Lossofchildsdependentstatus_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_Terminationofemployment_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_Terminationofemployment_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  Disabledonthedateofqualifyingevent.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_monthcoverage18_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_monthcoverage18_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  //this.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_monthcoverage29_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_monthcoverage29_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_monthcoverage36_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_monthcoverage36_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value  === "1"){
  monthcoverage18.value = "";
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_panel1587123018548_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_panel1587123018548_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FTE_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FTE_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_EmplID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_EmplID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = this.value;
if(cwid !== null){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_logUser_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_logUser_init0 = function (scope) {
    with(this) {
        with(scope) {
            $.ajax({
type: 'GET',
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_SSN_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_SSN_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_SSNEmp_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_SSNEmp_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = this.value;
if((this.value).indexOf("-") == -1){ 
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName6_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName6_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN6_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN6_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName7_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName7_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN7_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN7_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName8_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName8_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN8_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN8_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName9_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName9_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN9_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN9_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemName10_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemName10_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            var cwid = SSN.value;
var depName = this.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN10_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_FamilyMemberSSN10_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
if((this.value).indexOf("-") == -1){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_signatureReview_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_signatureReview_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_checkbox_20772941081589972929003_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_checkbox_20772941081589972929003_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated__valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated__valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  /*var fnVal = FirstName.value;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_generateDOR_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_generateDOR_click0 = function (scope) {
    with(this) {
        with(scope) {
            var submitFlag = 0;
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_saveguidedraft1589870024328_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_saveguidedraft1589870024328_click0 = function (scope) {
    with(this) {
        with(scope) {
            if(SSN.value !== null){
...
/**
 * @function vsp_cobra_vsp_cobra_old.generated_submit1589870048344_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
vsp_cobra_vsp_cobra_old.generated_submit1589870048344_click0 = function (scope) {
    with(this) {
        with(scope) {
