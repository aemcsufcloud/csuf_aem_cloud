...
function getCDAFinancialAidYear(financialAidYear) {
    ...
    var headingTextVal = "";
    headingTextVal = "<p><b>IDENTITY VERIFICATION AND STATEMENT OF EDUCATIONAL PURPOSE (".concat(financialAidYear).concat(")</b><br><i>Incomplete documents will not be returned. They will be disposed of in a secure manner, per university policy. This will delay processing.</i></p>");
...
/**
 * @function identity_verification_and_statement_of_educational_purpose_identity_verification_and_statement_of_educational_purpose.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
identity_verification_and_statement_of_educational_purpose_identity_verification_and_statement_of_educational_purpose.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    $.ajax({
...
function aidYearPopup() {
    ...
    document.getElementById("button1").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = prefixVal+"IDSP";
        formCodeVal = prefixVal+"IDSP";
        getCDAFinancialAidYear(aidYearValue);
...
function singleAidYear() {
    ...
    if (typeOfAidYear == '0') {
        ...
        var prefixValues = singleFinancialAidvalues.FormCodeGeneral;
        financialAidYearVal = singleFinancialAidvalues.FinAidYearGeneral;
        AidYear.value =  singleFinancialAidvalues.AidYearGeneral;
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = prefixValues+"IDSP";
        formCodeVal = prefixValues+"IDSP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal,financialAidYearVal);
    }
...
/**
 * @function identity_verification_and_statement_of_educational_purpose_identity_verification_and_statement_of_educational_purpose.generated_StudentComments_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
identity_verification_and_statement_of_educational_purpose_identity_verification_and_statement_of_educational_purpose.generated_StudentComments_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible=false;
        }
...
guideBridge.submit();
  ...
  showErrorModal("Alert !", "Please select the checkbox under Declaration section");
