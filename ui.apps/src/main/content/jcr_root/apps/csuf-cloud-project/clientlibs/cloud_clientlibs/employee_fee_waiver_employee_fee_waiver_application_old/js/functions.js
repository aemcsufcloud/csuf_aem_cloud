/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
  var status;
    ...
    $.ajax({
        ...
        success: function(myresopnse) {
            ...
            $.ajax({
                ...
                data: {
                    userId: userValue,
                    groupId: "HRDI/Total Wellness Reviewers"
                },
                dataType: 'json',
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_textdraw1577382730893_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_textdraw1577382730893_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_empInformation_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_empInformation_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_empId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_empId_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled= false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_empId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_empId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_firstName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_firstName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_lastName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_lastName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_departmentName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_departmentName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_bargainingUnit_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_bargainingUnit_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_bargainingUnit_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_bargainingUnit_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_jobCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_jobCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_temporary_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_temporary_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_semester_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_semester_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_year_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_year_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_campus_Attending_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_campus_Attending_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null && campus_attended_status.value === null){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_classStanding_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_classStanding_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_classStanding_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_classStanding_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_approvedPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_approvedPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  major.enabled = true;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_approvedPlan_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_approvedPlan_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  major.enabled = true;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_courseInfoComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_courseInfoComment_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle1_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle1_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_hours1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_hours1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null || StageIndicator.value == "ToEmployee"){
if(this.value !== null){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime1_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime1_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle2_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_courseTitle2_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null || StageIndicator.value == "ToEmployee") {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_hours2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_hours2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null || StageIndicator.value == "ToEmployee"){
if(this.value !== null){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null && campus_Attending.value == "Fullerton" ){
  if(this.value !== null){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime2_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTime2_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_comment1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_comment1_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_reqReimbursement_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_reqReimbursement_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null || StageIndicator.value == "ToEmployee"){
  this.enabled = true;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_instructions_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_instructions_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    this.enabled = true;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_EmployeeSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_EmployeeSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  if(this.value == "1"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_empCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_empCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  if(this.value == "1"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_authorizationInitials_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_authorizationInitials_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_empSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_empSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_dateInitiated_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_dateInitiated_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_textdraw_3096286811598517084121_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_textdraw_3096286811598517084121_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_chairCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_chairCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value === "ToChair" ) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_deptChairSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_deptChairSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_deptchairSignedDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_deptchairSignedDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_deanCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_deanCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value === "ToDean" ) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_collegeDeanSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_collegeDeanSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_collegeDeanSignedDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_collegeDeanSignedDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_ProvostPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_ProvostPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTimeCheck_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_releaseTimeCheck_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToSupervisor"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_WorkScheduleChangeCheck_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_WorkScheduleChangeCheck_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToSupervisor"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_supCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_supCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value === "ToSupervisor" ) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_supervisorSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_supervisorSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_supervisorSignedDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_supervisorSignedDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_adminCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_adminCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value === "ToAdmin" ) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_administratorSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_administratorSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_administratorSignedDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_administratorSignedDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_HRUseOnlyPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_HRUseOnlyPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_GrantOrDenyRB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_GrantOrDenyRB_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToHR"){    
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_GrantOrDenyRB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_GrantOrDenyRB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverGranted_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverGranted_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverGranted_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverGranted_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverDenied_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverDenied_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverDenied_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_feeWaiverDenied_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_term_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_term_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_EDDE_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_EDDE_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_EDDE_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_EDDE_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "SE2G"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_hrCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_hrCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  if(this.value == "1"){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_hiddenFields_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_hiddenFields_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_HiddenInitiatedDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_HiddenInitiatedDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            var dateString = new Date().toLocaleString("en-US", {
timeZone: (Intl.DateTimeFormat().resolvedOptions().timeZone)
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_LogUser_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_LogUser_init0 = function (scope) {
    with(this) {
        with(scope) {
            //alert("on top")	;
$.ajax({
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_ClassStandingCode1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_ClassStandingCode1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_extension_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_extension_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_deptId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_deptId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  debugger;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_ChairUserId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_ChairUserId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  var val2 = this.value;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_ManagerUserID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_ManagerUserID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  var val1 = this.value;
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_workflow_initiator_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_workflow_initiator_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
$.ajax({
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_GenerateDOR_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_GenerateDOR_click0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_GenerateDOR_click1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_GenerateDOR_click1 = function (scope) {
    with(this) {
        with(scope) {
            if(empId.value === null){
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_saveguidedraft1577420972539_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_saveguidedraft1577420972539_click0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application_old.generated_submit1577420963057_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
employee_fee_waiver_employee_fee_waiver_application_old.generated_submit1577420963057_click0 = function (scope) {
    with(this) {
        with(scope) {
...
EmailSubject.value = "Test - Employee Fee Waiver Request - "+ lastName.value;
}else{
 EmailSubject.value = "Test - Employee Fee Waiver Request"; 
}
