...
titan_card_titan_card.generated_guideRootPanel_init1 = function (scope) {
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          //  userValue = "nancykataria";
          userValue = "edgararmenta";
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.length >= 1) {
                ...
                PreferredLastName.value = response[0].PREFERRED_LNAME; 
                PreferredFirstName.value = response[0].PREFERRED_FNAME;
...
/**
 * @function titan_card_titan_card.generated_Cwid_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_Cwid_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function titan_card_titan_card.generated_ITFinanceCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_ITFinanceCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToITFinance") {
    if (this.value == 1) {
...
/**
 * @function titan_card_titan_card.generated_ItAVPStaffSignatureCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_ItAVPStaffSignatureCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToITAVPStaff") {
    if (this.value == 1) {
...
/**
 * @function titan_card_titan_card.generated_ASCStaffSignatureCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_ASCStaffSignatureCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToASCStaff") {
    if (this.value == 1) {
...
/**
 * @function titan_card_titan_card.generated_ASCStaffTwoSignatureCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_ASCStaffTwoSignatureCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToASCStaffTwo") {
    if (this.value == 1) {
...
/**
 * @function titan_card_titan_card.generated_ASCStaffThreeSignatureCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_ASCStaffThreeSignatureCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToASCStaffThree") {
    if (this.value == 1) {
...
/**
 * @function titan_card_titan_card.generated_CRApprovedBy3_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_CRApprovedBy3_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled= false;
        }
...
/**
 * @function titan_card_titan_card.generated_CRApprovedByDate3_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
titan_card_titan_card.generated_CRApprovedByDate3_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
