...
/**
 * @function manual_cd048_manual_cd048_student_asst_attendance___distributed.generated_hiddenPanel_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
manual_cd048_manual_cd048_student_asst_attendance___distributed.generated_hiddenPanel_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
...
EmailSubject.value = "Test - Request for Manual CD048 Student Assistant Attendance";  
...
/*TimekeeperEmailId.value = "chaitanya.sai@thoughtfocus.com";
AuthApproverEmailId.value = "chaitanya.sai@thoughtfocus.com";*/
