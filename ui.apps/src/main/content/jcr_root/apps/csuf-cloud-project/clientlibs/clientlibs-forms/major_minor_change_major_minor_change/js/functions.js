/**
 * @function major_minor_change_major_minor_change.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
					...
					$.ajax({
						...
						success: function(myresponse){
                          ...
                          //      if(myresponse[0].ADMIT_TERM == "2223" && myresponse[0].FUL_COLLEGE == "10039" && acadPlanVal.startsWith("42") && myresponse[0].LOA_FLAG == 'Y'){
                                  if(myresponse[0].ADMIT_TERM == "2267" && myresponse[0].FUL_COLLEGE == "10039" && acadPlanVal.startsWith("42") && myresponse[0].LOA_FLAG == 'Y'){
                                  ...
                                  else if(myresponse[0].ADMIT_TERM == "2267"){
                                      showErrorModal("Alert !","Newly admitted freshmen and transfers must wait until the first day of the term to add or change majors or minors.");
                                      gifModal.style.display = "none";
                                  }                                 
                                  else{                                                                        
...
/**
 * @function major_minor_change_major_minor_change.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_caseId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_caseId_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentInformationPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentInformationPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentCWID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentCWID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentFirstName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentFirstName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentLastName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentLastName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentMiddleName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentMiddleName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentPhone_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentPhone_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentEmail_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentEmail_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentInformationTabCurrentMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentInformationTabCurrentMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CatalogYear_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CatalogYear_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_HiddenCurrentAdditionalMajorListwith9Chars_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_HiddenCurrentAdditionalMajorListwith9Chars_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_HiddenMinorToMajorCheck_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_HiddenMinorToMajorCheck_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_HiddenCurrentAdditionalMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_HiddenCurrentAdditionalMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorToNewMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorToNewMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){ 
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorToNewMajorCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorToNewMajorCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_NewMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_NewMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_NewMajor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_NewMajor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorAcadPlanCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorAcadPlanCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_NewMajorAcadPlanCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_NewMajorAcadPlanCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureNewMajorConcentrationCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureNewMajorConcentrationCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureNewMajorConcentrationCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureNewMajorConcentrationCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentNewMajorDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentNewMajorDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorConcentrationColumn_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorConcentrationColumn_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondMajor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondMajor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondMajorAcadCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondMajorAcadCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalNewMajor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalNewMajor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            	if(StageIndicator.value === null){
		var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajorAcadCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalCurrentMajorAcadCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeAdditionalNewMajorAcadCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeAdditionalNewMajorAcadCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropSecondMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropSecondMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){  
...
/**
 * @function major_minor_change_major_minor_change.generated_DropSecondMajorCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropSecondMajorCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorToDrop_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorToDrop_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorToDrop_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorToDrop_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
						   ...
						   data:  {                      
							...
							success: function(myresponse){
									if(myresponse.length >= 0){
                                      ...
                                      if(program == "Urban Learning, BA."){
                                        HiddenChairEmailDropMajor.value = "clewischiu@FULLERTON.EDU";
										HiddenChairUserIDDropMajor.value = "clewischiu";
										HiddenChairNameDropMajor.value = "Calli Lewis Chiu";
                                      }
									}
							}
						}); // end 1st ajax	
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorToDropAcadPlanCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorToDropAcadPlanCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajorCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentSignatureAddSecondMajor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DepartmentAddSecondMajorDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DepartmentAddSecondMajorDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareMinorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareMinorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareMinor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareMinor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareMinor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareMinor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareMinorAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareMinorAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondOrThirdMinorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondOrThirdMinorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondOrThirdMinor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondOrThirdMinor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondOrThirdMinor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondOrThirdMinor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_AddSecondOrThirdMinorAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AddSecondOrThirdMinorAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeMinorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeMinorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeCurrentMinor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeCurrentMinor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeCurrentMinor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeCurrentMinor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeNewMinor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeNewMinor_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeNewMinor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeNewMinor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeCurrentMinorAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeCurrentMinorAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_ChangeNewMinorAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_ChangeNewMinorAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_FirstMinorSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_FirstMinorDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_FirstMinorDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondMinorSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToChairMinor"){
  if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondMinorDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondMinorDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareCertificateCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareCertificateCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareCertificate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareCertificate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareCertificate_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareCertificate_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DeclareCertificateAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DeclareCertificateAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificate_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificate_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){ 
    var gifModal = document.getElementById('gifModal');
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateAcadPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateAcadPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_studentCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_studentCB_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_studentCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_studentCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_studentCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_studentCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function major_minor_change_major_minor_change.generated_StudentDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_StudentDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_RecordsOfficeUseOnlyPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_RecordsOfficeUseOnlyPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
    ...
    $.ajax({
        type: 'GET',
        url: "/bin/getMajorMinorDataForRecordsReview",
        data: {
            action: 'MAJOR_MINOR_DATA_LOOKUP',
            cwid: StudentCWID.value,
            termDescr: CatalogYear.value,
            program: StudentInformationTabCurrentMajor.value
        },
        dataType: 'json',
        success: function(myresponse) {
           debugger;
            if (myresponse.length >= 1) {
                acadNumber = myresponse[0].STDNT_CAR_NBR;
                termnumber = myresponse[0].ADMIT_TERM;
                AcadCarNumber.value = myresponse[0].STDNT_CAR_NBR;
                strmHidden.value = myresponse[0].ADMIT_TERM;
                checkMinors(function(minorsResult) {
                    window.minorsResult = minorsResult;
                    checkCertificates(function(certificatesResult) {
                        window.certificatesResult = certificatesResult;
                        resume();
                    });
                });
                resume();
            } else {
                showErrorModal("Alert !", "Unable to retrieve student data at the moment for PeopleSoft update.");
            }
        },
        error: function(error) {
            showErrorModal("Alert !", "Unable to retrieve student data at the moment for PeopleSoft update.");
...
function resume() {
    $("#consolidateTable").empty();
    var arrayofArrays = [];
    var programActionFlag = false;

    // Changing Primary Major Block
    if (CurrentMajorToNewMajorCHK.value === "1") {
        var currMajorVal = CurrentMajor.value;
        var programAction = currMajorVal.toLowerCase().includes("undeclared") ? "PLNC" : "PLNF";
        var decisionVal = DepartmentSignatureNewMajorAction.value;
        var status = (decisionVal && decisionVal.includes("1")) ? "Yes" : "No";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Changing to new major",
            requestFor: "Major",
            requestType: "Change",
            currentPlan: currMajorVal,
            currentPlanCode: CurrentMajorAcadPlanCode.value,
            newPlan: NewMajor.value,
            newPlanCode: NewMajorAcadPlanCode.value,
            programAction: programAction,
            programActionReason: "CHGP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
            upgrade: status
        });
    ...
    // Adding new Additional Major Block
    if (AddSecondMajorCHK.value === "1") {
        var decisionValSM = DepartmentSignatureAddSecondMajorAction.value;
        var statusSM = (decisionValSM && decisionValSM.includes("1")) ? "Yes" : "No";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Adding an additional major",
            requestFor: "Additional Major",
            requestType: "Add",
            currentPlan: "",
            currentPlanCode: "",
            newPlan: AddSecondMajor.value,
            newPlanCode: AddSecondMajorAcadCode.value,
            programAction: "PLNF",
            programActionReason: "ADDP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
            upgrade: statusSM
    ...
    // Changing Additional Major Block
    if (ChangeAdditionalMajorCHK.value === "1") {
        var decisionValCAM = DepartmentSignatureAddSecondMajorAction.value;
        var statusCAM = (decisionValCAM && decisionValCAM.includes("1")) ? "Yes" : "No";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Changing an additional major",
            requestFor: "Additional Major",
            requestType: "Change",
            currentPlan: ChangeAdditionalCurrentMajor.value,
            currentPlanCode: ChangeAdditionalCurrentMajorAcadCode.value,
            newPlan: ChangeAdditionalNewMajor.value,
            newPlanCode: ChangeAdditionalNewMajorAcadCode.value,
            programAction: "PLNF",
            programActionReason: "CHGP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
    ...
    // Dropping Additional Major Block
    if (DropSecondMajorCHK.value === "1") {
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Dropping an additional major",
            requestFor: "Additional Major",
            requestType: "Drop",
            currentPlan: MajorToDrop.value,
            currentPlanCode: MajorToDropAcadPlanCode.value,
            newPlan: "",
            newPlanCode: "",
            programAction: "PLNF",
            programActionReason: "DRPP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
            upgrade: "Yes"
    ...
    // Declaring Minor Block
    if (DeclareMinorCHK.value === "1") {
        var decisionValMin = FirstMinorAction.value;
        var statusMin = (decisionValMin && decisionValMin.includes("1")) ? "Yes" : "No";
        var paCode = window.minorsResult ? "PLNF" : "PLNC";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Declaring a minor",
            requestFor: "Minor",
            requestType: "Add",
            currentPlan: "",
            currentPlanCode: "",
            newPlan: DeclareMinor.value,
            newPlanCode: DeclareMinorAcadPlan.value,
            programAction: paCode,
            programActionReason: "ADDP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
    ...
    // Declaring Second or Third minor Block
    if (AddSecondOrThirdMinorCHK.value === "1") {
        var decisionValSecMin = SecondMinorAction.value;
        var statusSecMin = (decisionValSecMin && decisionValSecMin.includes("1")) ? "Yes" : "No";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Adding second or third minor",
            requestFor: "Minor",
            requestType: "Add",
            currentPlan: "",
            currentPlanCode: "",
            newPlan: AddSecondOrThirdMinor.value,
            newPlanCode: AddSecondOrThirdMinorAcadPlan.value,
            programAction: "PLNF",
            programActionReason: "ADDP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
            upgrade: statusSecMin
        });
    }
    ...
    if (DropMinorCHK.value === "1") {
        arrayofArrays.push({
            ...
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Dropping a minor",
            requestFor: "Minor",
            requestType: "Drop",
            currentPlan: DropMinor.value,
            currentPlanCode: DropMinorAcadPlan.value,
            newPlan: "",
            newPlanCode: "",
            programAction: "PLNF",
            programActionReason: "DRPP",
    ...
    // Change Current Minor Block
    if (ChangeMinorCHK.value === "1") {
        var decisionValChaMin = SecondMinorAction.value;
        var statusChaMin = (decisionValChaMin && decisionValChaMin.includes("1")) ? "Yes" : "No";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            ...
            requestFor: "Minor",
            requestType: "Drop",
            currentPlan: ChangeCurrentMinor.value,
            currentPlanCode: ChangeCurrentMinorAcadPlan.value,
            newPlan: "",
            newPlanCode: "",
            programAction: "PLNF",
            programActionReason: "DRPP",
            ...
            acadCarrer: acadPlan,
            strm: termnumber,
            upgrade: statusChaMin
        });
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Adding a minor",
            requestFor: "Minor",
            requestType: "Add",
            currentPlan: "",
            currentPlanCode: "",
            newPlan: ChangeNewMinor.value,
            newPlanCode: ChangeNewMinorAcadPlan.value,
            programAction: "PLNF",
            programActionReason: "ADDP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
    ...
    // Declare a Certificate Block
    if (DeclareCertificateCHK.value === "1") {
        var decisionValCert = CertificateAction.value;
        var statusCert = (decisionValCert && decisionValCert.includes("1")) ? "Yes" : "No";
        var paCodeCert = window.certificatesResult ? "PLNF" : "PLNC";
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Declaring a certificate",
            requestFor: "Certificate",
            requestType: "Add",
            currentPlan: "",
            currentPlanCode: "",
            newPlan: DeclareCertificate.value,
            newPlanCode: DeclareCertificateAcadPlan.value,
            programAction: paCodeCert,
            programActionReason: "ADDP",
            acadNumber: acadNumber,
            acadCarrer: acadPlan,
            strm: termnumber,
    ...
    // Drop a Certificate Block
    if (DropCertificateCHK.value === "1") {
        arrayofArrays.push({
            cwid: StudentCWID.value,
            term: CatalogYear.value,
            date: getDateforAdaptiveForm(),
            request: "Dropping a certificate",
            requestFor: "Certificate",
            requestType: "Drop",
            currentPlan: DropCertificate.value,
            currentPlanCode: DropCertificateAcadPlan.value,
            newPlan: "",
            newPlanCode: "",
            programAction: "PLNF",
            programActionReason: "DRPP",
    ...
    for (var i = 0; i < arrayofArrays.length; i++) {
        if (arrayofArrays[i].programAction === "PLNF") {
            plnfCount++;
            if (plnfCount > 1) {
                arrayofArrays[i].programAction = "PLNC";
            }
        }
    }

    var generatedtable = createTable(arrayofArrays);
    textdraw1754463333641.visible = true;
    $("#consolidateTable").append(generatedtable);
}
...
function createTable(Data) {
    ...
    col.push("request");
    col.push("requestFor");
    col.push("requestType");
    col.push("currentPlan");
    col.push("currentPlanCode");
    col.push("newPlan");
    col.push("newPlanCode");
    col.push("programAction");
    col.push("programActionReason");
    col.push("upgrade");

    var table = document.createElement("table");
    table.id = "tb";
    var caption = document.createElement("caption");
    caption.innerHTML = "Consolidated Information";
    table.appendChild(caption);


    var tr = table.insertRow(-1);
    var headings = ["CWID", "Term", "STRM", "Acad No.", "Date", "Request", "Request For", "Request Type", "Current Plan", "Current Plan Code", "New Plan", "New Plan Code", "Program Action", "Program Action Reason", "PS Update"];
    ...
    for (var k = 0; k < Data.length; k++) {
        ...
        for (var l = 0; l < col.length; l++) {
            ...
            if (l === 1) { // Term column
                ...
                termInput.type = "text";
                termInput.value = Data[k][col[l]];
                termInput.style.width = "100%";
                termInput.style.fontSize = "12px";
                termInput.style.padding = "2px";
                termInput.style.border = "1px solid #ccc";
                termInput.style.boxSizing = "border-box";

                (function(rowIndex, colIndex) {
                    termInput.addEventListener("input", function() {
                        Data[rowIndex][col[colIndex]] = this.value;
                    });
                ...
                tabCell.appendChild(termInput);
            } else if (l === 2) { // STRM column
                var strmInput = document.createElement("input");
                strmInput.type = "text";
                strmInput.value = Data[k][col[l]];
                strmInput.style.width = "100%";
                strmInput.style.fontSize = "12px";
                strmInput.style.padding = "2px";
                strmInput.style.border = "1px solid #ccc";
                strmInput.style.boxSizing = "border-box";

                (function(rowIndex, colIndex) {
                    strmInput.addEventListener("input", function() {
                        Data[rowIndex][col[colIndex]] = this.value;
                    });

                    strmInput.addEventListener("blur", function() {
                        Data[rowIndex][col[colIndex]] = this.value;
                    });
                })(k, l);

                tabCell.appendChild(strmInput);
            } else if (l === 12) { // Program Action column (13th column, index 12)
                var programActionSelect = document.createElement("select");
                programActionSelect.style.width = "100%";
                programActionSelect.style.fontSize = "12px";
                programActionSelect.style.padding = "2px";
                programActionSelect.setAttribute("data-row-index", k);
                programActionSelect.setAttribute("data-column-type", "program-action");

                var options = ["PLNC", "PLNF"];
                options.forEach(function(option) {
                    var opt = document.createElement("option");
                    opt.value = option;
                    opt.text = option;
                    if (option === Data[k][col[l]]) {
                        opt.selected = true;
                    }
                    programActionSelect.appendChild(opt);
                });

                programActionSelect.addEventListener("change", function() {
                    var selectedValue = this.value;
                    var currentRowIndex = parseInt(this.getAttribute("data-row-index"));


                    if (selectedValue === "PLNF") {
                        for (var i = 0; i < Data.length; i++) {
                            Data[i][col[l]] = "PLNC";
                        }
                        Data[currentRowIndex][col[l]] = "PLNF";
                        var allProgramActionSelects = table.querySelectorAll("select[data-column-type='program-action']");
                        allProgramActionSelects.forEach(function(select) {
                            var rowIndex = parseInt(select.getAttribute("data-row-index"));
                        ...
                        Data[currentRowIndex][col[l]] = "PLNC";
                    }
                });

                tabCell.appendChild(programActionSelect);
            } else if (l === 13) { // Program Action Reason column (14th column, index 13)
                var reasonInput = document.createElement("input");
                reasonInput.type = "text";
                reasonInput.value = Data[k][col[l]];
                reasonInput.style.width = "100%";
                reasonInput.style.fontSize = "12px";
                ...
                tabCell.appendChild(reasonInput);
            } else if (l === 14) { // PS Update column (15th column, index 14)
                var psUpdateSelect = document.createElement("select");
                psUpdateSelect.style.width = "100%";
                psUpdateSelect.style.fontSize = "12px";
                psUpdateSelect.style.padding = "2px";
                psUpdateSelect.setAttribute("data-row-index", k);
                psUpdateSelect.setAttribute("data-column-type", "ps-update");

                var psOptions = ["Yes", "No"];
                psOptions.forEach(function(option) {
                    var opt = document.createElement("option");
                    opt.value = option;
                    opt.text = option;
                    if (option === Data[k][col[l]]) {
                    ...
                    psUpdateSelect.appendChild(opt);
                });

                psUpdateSelect.addEventListener("change", function() {
                    var selectedValue = this.value;
                    var currentRowIndex = parseInt(this.getAttribute("data-row-index"));
                    Data[currentRowIndex][col[l]] = selectedValue;
                });

                tabCell.appendChild(psUpdateSelect);
            } else {
...
function checkMinors(callback) {
    $.ajax({
        type: 'GET',
        url: "/bin/getCurrentMinors",
        data: {
            userID: workflow_initiator.value,
        },
        dataType: 'json',
        success: function(myresponse) {
            callback(myresponse && myresponse.length > 0);
        },
...
/**
 * @function major_minor_change_major_minor_change.generated_PeopleSoftUpdateSelection_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_PeopleSoftUpdateSelection_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
    $("#psstatus").html("<p>Status - <b style='color:grey'>In Progress</b></p>");
    generateJSONFromTable();
    textdraw_10903390401755164932602.visible = true;
}
...
function getUpdatedTableData() {
    ...
    var col = ["cwid", "term", "strm", "acadNumber", "date", "request", "requestFor", "requestType", "currentPlan", "currentPlanCode", "newPlan", "newPlanCode", "programAction", "programActionReason"];

    for (var i = 1; i < rows.length; i++) {
        var row = rows[i];
        var rowData = {};
        var psUpdateCell = row.cells[row.cells.length - 1];
        var psUpdateValue = psUpdateCell.querySelector("select").value;

        if (psUpdateValue === "Yes") {
            for (var j = 0; j < row.cells.length - 1; j++) {
                var cell = row.cells[j];
                var columnName = col[j];

                if (j === 1 || j === 2) {
                    rowData[columnName] = cell.querySelector("input").value;
                } else if (j === 12) {
                    rowData[columnName] = cell.querySelector("select").value;
                } else if (j === 13) {
                    rowData[columnName] = cell.querySelector("input").value;
                } else {
                    rowData[columnName] = cell.innerHTML;
                }
            }
...
function generateJSONFromTable() {
    ...
    var tableData = getUpdatedTableData();

    if (tableData.length === 0) {
        $("#psstatus").html("<p>Status - <b style='color:red'>No data to process</b></p>");
        PeopleSoftUpdateSelection.value = "";
        return null;
    }

    var firstTerm = tableData[0].term;
    for (var i = 1; i < tableData.length; i++) {
        if (tableData[i].term !== firstTerm) {
            $("#psstatus").html("<p>Status - <b style='color:red'>Term cannot be different for each row. All rows must have the same term.</b></p>");
            PeopleSoftUpdateSelection.value = "";
            return null;
        }
    }

    var requestType = tableData.length === 1 ? "Single" : "Multiple";

    var jsonOutput = {
        "cwid": tableData[0].cwid,
        "requirementTerm": tableData[0].term,
        "effectiveDate": tableData[0].date,
        "requestType": requestType,
        "careerNumber": AcadCarNumber.value,
        "career": "UGRD",
        "term": tableData[0].strm,
        "requests": []
    };
    ...
    for (var z = 0; z < tableData.length; z++) {
        ...
        var requestObject = {
            ...
            "newPlan": row.newPlan,
            "newPlanCode": row.newPlanCode,
            "programAction": row.programAction,
            "programActionReason": row.programActionReason
        };

        jsonOutput.requests.push(requestObject);
    }
    ...
    triggesPSSave(jsonString);
    return jsonOutput;
}

function triggesPSSave(jsonVal) {
    try {
        JSON.parse(jsonVal);
    } catch (e) {
        jsonVal = JSON.stringify(generateJSONTextBox.value);
    }

    $.ajax({
        url: '/bin/majorMinorPS.json',
        method: 'POST',
        data: {
            cwid: StudentCWID.value,
            acad: 'UGRD',
            acadNo: AcadCarNumber.value,
            requestJSON: jsonVal
        },
        success: function(response) {
            console.log('Success:', response);
            if (response.status === 'success') {
                $("#psstatus").html("<p>Status - <b style='color:green'>Success</b></p>");
            } else {
                $("#psstatus").html("<p>Status - <b style='color:red'>" + response.error + "</b></p>");
            }
        },
        error: function(xhr, status, error) {
            ...
            try {
                ...
                if (errorResponse.error) {
                    $("#psstatus").html("<p>Status - <b style='color:red'>" + errorResponse.error + "</b></p>");
                } else {
                    $("#psstatus").html("<p>Status - <b style='color:red'>Request failed: " + error + "</b></p>");
                }
            } catch (e) {
                $("#psstatus").html("<p>Status - <b style='color:red'>Request failed: " + error + "</b></p>");
            }
...
/**
 * @function major_minor_change_major_minor_change.generated_textdraw_10903390401755164932602_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_textdraw_10903390401755164932602_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_textdraw1754463333641_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_textdraw1754463333641_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorRecordsCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorRecordsCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorRecordsCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorRecordsCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToRecords"){
  if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MajorBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MajorBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AdditionalMajorRecordsCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AdditionalMajorRecordsCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_AdditionalMajorRecordsCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AdditionalMajorRecordsCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToRecords"){
  if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_AdditionalMajorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AdditionalMajorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondaMajorCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondaMajorCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_AdditionalMajorRecordsBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_AdditionalMajorRecordsBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MinorRecordsCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MinorRecordsCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToRecords"){	
	if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_MinorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MinorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_FirstCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_FirstCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_SecondCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_SecondCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_MinorBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_MinorBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateRecordsCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateRecordsCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateRecordsCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateRecordsCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CertificateBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CertificateBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMajorRecordsBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMajorRecordsBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToRecords"){
	if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropMinorRecordsBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropMinorRecordsBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCertificateRecordsBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCertificateRecordsBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_HiddenPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_HiddenPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_LogUser_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_LogUser_init0 = function (scope) {
    with(this) {
        with(scope) {
            $.ajax({
...
/**
 * @function major_minor_change_major_minor_change.generated_submit1589890835750_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_submit1589890835750_click0 = function (scope) {
    with(this) {
        with(scope) {
            //For description
...
/**
 * @function major_minor_change_major_minor_change.generated_submit1589890835750_click1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_submit1589890835750_click1 = function (scope) {
    with(this) {
        with(scope) {
