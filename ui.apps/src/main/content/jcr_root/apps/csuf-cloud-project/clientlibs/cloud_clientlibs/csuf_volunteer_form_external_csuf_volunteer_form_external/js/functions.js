...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
  SupervisorNoCB.value = null;
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_TruckCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_TruckCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorNoCB3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorNoCB3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_SupervisorYesCB3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_ChairNameDD_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_ChairNameDD_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === null)   {
...
/**
 * @function csuf_volunteer_form_external_csuf_volunteer_form_external.generated_DeanNameDD_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_DeanNameDD_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === null)   {
...
csuf_volunteer_form_external_csuf_volunteer_form_external.generated_formTitle_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.value = "CSUF Volunteer Form - External";
        }
	}
}
/**
