/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            var flag;
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value===null){
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_caseId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_caseId_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    $.ajax({
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_cwid_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_cwid_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_firstName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_firstName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_lastName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_lastName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_Date_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_Date_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if(StageIndicator.value === null){
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_financialAidYear_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_financialAidYear_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_SupportingDocuments_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_SupportingDocuments_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  this.visible = true;
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_supportDoc3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_StudentCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_StudentCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
	if (this.value == 1) {
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_ipAddress_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_ipAddress_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
if (StageIndicator.value === null) {     		
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_studentSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_studentSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_studentSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_studentSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_evaluator_signChk_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_evaluator_signChk_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToFinancialAid" ){
	if (this.value == 1) {
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_staffSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_staffSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_staffSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_staffSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_WorkflowInstanceID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_WorkflowInstanceID_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value !== null){
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_generateDOR_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_generateDOR_click0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
    ...
    window.guideBridge.getDataXML({
        success: function(result) {
           console.log("in view pdf="+result.data);
            ...
            jsonData.append('formPath', '/content/forms/af/parent-spouse-tax-return/test-parent-spouse-federal-tax-return');
...
/**
 * @function parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_submit1575264176703_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_tax_return_test_parent_spouse_federal_tax_return.generated_submit1575264176703_click0 = function (scope) {
    with(this) {
        with(scope) {
              debugger;
