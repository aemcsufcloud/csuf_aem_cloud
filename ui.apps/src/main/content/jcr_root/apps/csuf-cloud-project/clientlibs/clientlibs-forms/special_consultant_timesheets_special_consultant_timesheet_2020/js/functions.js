/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
        ...
        $.ajax({
            ...
            success: function(myresponse) {
                ...
                if (myresponse.length === 1) {
				   ...
				   SupEmail.value = myresponse[0].MANAGER_EMAIL_ID;
                } 
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null && formSavedStatus.value !== "1"){
$.ajax({
    ...
    success: function(myresopnse) {
      ...
      //debugger;
        $.ajax({
            ...
            data: {
                action: "SPECIAL_CONSULTANT_USERID",
                userId: userID
            },
            dataType: 'json',
                ...
                if (myresponse.length === 1) {
        		 ...
        		 //  AuthApproverEmailId.value = myresponse[0].MANAGER_EMAIL_ID;
                  // AuthApproverEmailId.value = "yjayaram@fullerton.edu";
        		   ...
        		   AuthApproverName.value = myresponse[0].SupervisorName;
				 //  SupEmail.value = myresponse[0].MANAGER_EMAIL_ID;
                 //  SupEmail.value = "yjayaram@fullerton.edu";
                    SupEmail.value = "shreyas.manjunatha@thoughtfocus.com";
                } 
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_MonthSelected_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_MonthSelected_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value !== null) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_YearSelected_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_YearSelected_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
//this.enabled = false;
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_YearSelected_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_YearSelected_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_CHRSID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_CHRSID_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_CHRSID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_CHRSID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
        ...
        success: function(myresopnse) {
            ...
            var chrsId = CHRSID.value;
                ...
                $.ajax({
                    ...
                    url: "/bin/chrsIDUpdateServlet",
                    data: {
                        action: "SPECIAL_CONSULTANT_CHRSID",
                        chrsId: chrsId,
                        userId: userID
                    },
                    dataType: 'json',
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_Empl_ID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_Empl_ID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_Day30_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_Day30_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_EmpCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_EmpCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
if (this.value == 1) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_EmpSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_EmpSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_DateEmpSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_DateEmpSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_TimekeeperCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_TimekeeperCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === "ToTimekeeper"){
if (this.value == 1) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_SupervisorCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_SupervisorCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === "ToManager"){
if (this.value == 1) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_SupSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_SupSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_DateSupSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_DateSupSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_PayrollCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_PayrollCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === "ToPayroll"){
if (this.value == 1) {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);
        DatePayrollSign.value = d;

        DatePayrollSign.enabled = false;
         $.ajax({
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_HiddenPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_HiddenPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_SSN1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_SSN1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToPayroll"){
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_generatePDF_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_generatePDF_click0 = function (scope) {
    with(this) {
        with(scope) {
            
if(Empl_ID.value !== null && MonthSelected.value !== null){
 getPdf();
}else{
    ...
    window.guideBridge.getDataXML({
        success: function(result) {
          console.log("in view pdf=="+result.data);
            ...
            jsonData.append('formPath', '/content/forms/af/special-consultant-timesheets/special-consultant-timesheet-2020');
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_saveguidedraft1594880823890_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_saveguidedraft1594880823890_click0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function special_consultant_timesheets_special_consultant_timesheet_2020.generated_submit1594880817645_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
special_consultant_timesheets_special_consultant_timesheet_2020.generated_submit1594880817645_click0 = function (scope) {
    with(this) {
        with(scope) {
            EmailSubject.value = "Test - Special Consultant Timesheet - " + Last_Name.value + ", " + First_Name.value + " ("+Empl_ID.value+" "+CHRSID.value+")";
...
EmpEmail.value =testEmail;
SupEmail.value = testEmail;
