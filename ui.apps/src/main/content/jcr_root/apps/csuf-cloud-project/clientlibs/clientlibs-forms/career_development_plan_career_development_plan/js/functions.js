...
if(this.value == 1){
        ...
        if (employeeDate.value === null) {
           /* var dateString = new Date().toLocaleString("en-US", {
            ...
            employeeDate.value = getDateforAdaptiveForm();
...
if(this.value == 1){
        ...
        if (analystDate.value === null) {
          /*  var dateString = new Date().toLocaleString("en-US", {
            ...
            var curyearDay = dateObject.getDate();
            var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
            analystDate.value = getDateforAdaptiveForm();
    ...
    with(this) {
     ...
     showErrorModal("Alert!","Please describe short- and/or long-term goals");
      ...
      if(lastName.value !== null){
        EmailSubject.value = "Test - Career Development Plan - "+lastName.value;
      }else{
        EmailSubject.value = "Test - Career Development Plan";
      }
