...
/*  $.ajax({
        ...
        success: function(myresponse) {
            ...
            getData();
          if(userValue == "kyledillon" || userValue == "omare2001" || userValue == "cjwilliamson" || userValue == "alondrarubi775" || userValue == "t.kanauchi"){
            getData();
          } else{
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.length !== 0) {
                        ...
                        //StudentEmailAddress.value = response[0].STUDENT_EMAIL;
                        StudentEmailAddress.value = "yjayaram@fullerton.edu";
...
if (StageIndicator.value === null) {
    for (i = 0; i < PopupTable.Row1.instanceManager.instanceCount; i++) {
        if (PopupTable.Row1.instanceManager.instances[i].PopupCB.value == "1") {
            ...
            var days = PopupTable.Row1.instanceManager.instances[i].CourseDays.value; //new line added on 01312023
            var courseParsedArray = JSON.parse(CourseListJson.value);
            for (a = 0; a < courseParsedArray.length; a++) {
   // Commented on 01312023 if (courseParsedArray[a].CRSE_NAME == courseName && courseParsedArray[a].INSTR_NAME == instructorName && courseParsedArray[a].CLASS_NBR == scheduleNumber) {
/* New line added on 01312023*/if (courseParsedArray[a].CRSE_NAME == courseName && courseParsedArray[a].INSTR_NAME == instructorName && courseParsedArray[a].CLASS_NBR == scheduleNumber && courseParsedArray[a].COURSE_DAYS == days) {
                  ...
                  //  RequestedCourseInstructorEmailId.value = courseParsedArray[a].INSTR_EMAIL;
                    RequestedCourseInstructorEmailId.value = "yjayaram@fullerton.edu";
    ...
    for (a = 0; a < timeConflictCourseParsedArray.length; a++) {
        if (timeConflictCourseParsedArray[a].CRSE_NAME == timeConflictCourseName) {
           ...
           // TimeConflictCourseInstructorEmailId.value = timeConflictCourseParsedArray[a].INSTR_EMAIL;
            TimeConflictCourseInstructorEmailId.value = "yjayaram@fullerton.edu";
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictScheduleNumber_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictScheduleNumber_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictNumberofUnits_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictNumberofUnits_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictDaysandTimes_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictDaysandTimes_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictInstructorName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictInstructorName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
                ...
                if (myresponse.length !== 0) {
                    ...
                    if (rowcountRemoveAll1 !== null) {
                        for (var k = 0; k < rowcountRemoveAll1; k++) {
                            PopupTable.Row1.instanceManager.removeInstance(Row1.instanceIndex);
                        }
                    }
                   ...
                   var rowcountRemoveAll3 = PopupTable.Row1.instanceManager.instanceCount;
                  if(myresponse.length<rowcountRemoveAll3){
                    for(var O=myresponse.length; O<=rowcountRemoveAll3 ; O++ ){
                      PopupTable.Row1.instanceManager.removeInstance(Row1.instanceIndex);
                    }
                  }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedDeptCourse_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedDeptCourse_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseScheduleNumber_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseScheduleNumber_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedNumberofUnits_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedNumberofUnits_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseDaysAndTimes_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseDaysAndTimes_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseInstructorName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseInstructorName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_StudentSignatureDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_StudentSignatureDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictInstructorSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_TimeConflictInstructorSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseInstructorSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_RequestedCourseInstructorSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
    ...
    if (this.value == 1) {
        $.ajax({
            ...
            success: function(myresponse) {
              ...
              RegistrationEnrollmentDate.value = myresponse.SERVER_DATE;
            },
            error: function(error) {
                alert("error block=" + error);
            }
...
/**
 * @function request_for_time_conflict_approval_request_for_time_conflict_approval.generated_ARSCSignatureDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_time_conflict_approval_request_for_time_conflict_approval.generated_ARSCSignatureDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
