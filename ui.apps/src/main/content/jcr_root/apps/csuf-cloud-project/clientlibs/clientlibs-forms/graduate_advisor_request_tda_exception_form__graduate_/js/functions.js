...
if(StageIndicator.value == "ToEval"){
  ...
  ExceptionTab.visible=true;
  Exception_1.visible=true;
  Exception_1.enabled=false;
  Exception_2.visible=true;
  Exception_2.enabled=false;
  Exception_3.visible=true;
  TimeExtensionCheck.enabled=false;
  TimeExtension_Notes.enabled=false;
  ThesisCompleteDate.enabled=true;
  Other.enabled=false;
...
graduate_advisor_request_tda_exception_form__graduate_.generated_guideRootPanel_init2 = function (scope) {
    ...
    var gifModal = document.getElementById('gifModal');
    gifModal.style.display = "block";
			var sql = "ACAD_PROG in ('GRD','GRED') ORDER BY PROGRAMS ASC";       
				$.ajax({
				   ...
				   data:  {
					...
					success: function(myresponse){
                        ...
                        for (var i = 0; i < myresponse.length; i++) { 
                            var item = myresponse[i].ACAD_PLAN + " - " + myresponse[i].PROGRAMS;
                            progarray.push(item);
                        }
                        progarray.push("42ISMAPMBA - MBA Business Administration, Marketing Analytics concentration");     
                        GraduateDegProg.items = progarray.sort();   
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_Course_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_Course_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_ReplaceCourse_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_ReplaceCourse_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_Area_CS_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_Area_CS_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
  Course.mandatory=true;
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_Reason_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_Reason_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
  Course.mandatory=true;
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_WaiveCourse_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_WaiveCourse_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
  WaiveReason.mandatory=true;
} else {
  WaiveReason.mandatory=false;
}
        }
	}
}
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_WaiveReason_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_WaiveReason_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value!==null){
  WaiveCourse.mandatory=true;
} else {
  WaiveCourse.mandatory=false;
}
        }
	}
}
...
/**
 * @function graduate_advisor_request_tda_exception_form__graduate_.generated_ThesisCompleteDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
graduate_advisor_request_tda_exception_form__graduate_.generated_ThesisCompleteDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if(StageIndicator.value == "ToAVP") {
...
if(StageIndicator.value === null){
  ...
  EmailSubject.value = "Test - TDA Exception Form (Graduate) - "+StudentName.value+" - "+CWID.value;
