...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            var flag;
if (StageIndicator.value === null) {
...
function aidYearPopup() {
    ...
    document.getElementById("button1").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FinAidYearFormCodeOne + "STXP";
        formCodeVal = financialAidvalues.FinAidYearFormCodeOne + "STXP";
        getCDAFinancialAidYear(aidYearValue);
    ...
    document.getElementById("button2").onclick = function() {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FinAidYearFormCodeTwo + "STXP";
        formCodeVal = financialAidvalues.FinAidYearFormCodeTwo + "STXP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    };
}
...
function singleAidYear() {
    ...
    if (typeOfAidYear == '0') {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FormCodeGeneral + "STXP";
        formCodeVal = financialAidvalues.FormCodeGeneral + "STXP";
        getCDAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    }
...
function getCDAFinancialAidYear(financialAidYear) {
    ...
    var textChange = getUniqueStatements("PARENT_FEDERAL_TAX_RETURN", aidYearVal, "");
    ...
    HeadingYear.value = "PARENT SPOUSE ".concat(taxFillingYear).concat(" FEDERAL TAX RETURN - PARENT (".concat(financialAidYear).concat(")"));
    Year_1.value = financialAidYear;
    Year_2.value = TextOneChange;
    Year_3.value = TextTwoChange;
    Year_4.value = taxFillingYear;
    Year_5.value = taxFillingYear;
    VerificationText.value = TextThreeChange;
    ...
    var headingTextVal = "<p><b>PARENT SPOUSE ".concat(taxFillingYear).concat(" FEDERAL TAX RETURN - PARENT (".concat(financialAidYear).concat(")</b></p>"));
    var formTextVal = "<p><b>" + formCode.value + "</b></p>";
    var TextOne = "<p><b><u>INSTRUCTIONS:</u></b>&nbsp; Additional information is needed to determine your financial aid eligibility for the ".concat(financialAidYear).concat(" award year. Our records show that your parents were “married,” “remarried,” or “unmarried, and both parents living together” on or before the date you filed your Free Application for Federal Student Aid (FAFSA). Federal regulations require that we must include both parents’ information to determine the amount of financial aid that you are eligible to receive. We must include both parents’ information even if they did not file taxes jointly. This Federal regulation applies even if they were married in the later part of ".concat(TextOneChange).concat("&nbsp;<i>Incomplete documents will not be returned. They will be disposed of in a secure manner, per university policy. This will delay processing.</i></p>"));
    var TextTwo = "<p>Submit a signed photocopy of your <i>".concat(TextTwoChange).concat("</i></p>");
    var TextThree = "<p><b>NOTE:</b>&nbsp; If your parent(s) were married as of December 31, ".concat(taxFillingYear).concat(", federal tax regulations prohibit them from filing as head-of-household. If either of the 1040's submitted to our office show that one or both parents filed as head-of-household, your financial aid application will be placed on hold unti l an amended tax return is filed for your parents, unless they can demonstrate they met the Internal Revenue Service definition of head-of-household. If two separate Federal Tax Returns were not filed, provide a written explanation why the one parent or (stepparent) filed, but the other parent (or stepparent) did not file.</p>");
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_yesCFCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_yesCFCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noCFCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noCFCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noUseIRSCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noUseIRSCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	separatedCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_separatedCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_separatedCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	noUseIRSCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_ForeignTRCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_ForeignTRCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
  	noUseIRSCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_taxExtensionCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_taxExtensionCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
  	noUseIRSCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_foreignTaxCHK12025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_foreignTaxCHK12025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
  	noUseIRSCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noIncomeCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_noIncomeCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	notRequireFileCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_notRequireFileCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_notRequireFileCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	noIncomeCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_SSNchk2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_SSNchk2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	noIncomeCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_InterOrgCHK2025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_InterOrgCHK2025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	noIncomeCHK2025.value = null;
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1a_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1a_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1a_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1a_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1b_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1b_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1b_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1b_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1c_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_empName1c_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1c_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
parent_spouse_federal_tax_return_parent_spouse_federal_tax_return.generated_amount1c_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
if(StageIndicator.value === null){
  ...
  EmailSubject.value = "Parent Spouse Federal Tax Return Form - (" + cwid.value + ")";
  //HiddenStudentEmail.value = "thamizhvanan.sathiyamoorthy@thoughtfocus.com";
  HiddenStudentEmail.value = "shreyas.manjunatha@thoughtfocus.com";
}
documentNameForAdobeSign.value = "Parent Spouse Federal Tax Return - " + formCode.value;
guideBridge.submit();
}
        }
	}
