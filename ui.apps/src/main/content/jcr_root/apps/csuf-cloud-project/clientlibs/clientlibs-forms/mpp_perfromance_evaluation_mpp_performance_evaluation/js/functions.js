...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_guideRootPanel_init4
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_guideRootPanel_init4 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null && formSavedStatus.value === null){
...
success: function(myresopnse){
  ...
  if(myresopnse.length !== 0){
    for(i=0;i<myresopnse.length;i++){
      if(myresopnse[i].UNION_CD == ("M80" || "M98")){
        CBIDFlag.value = myresopnse[i].UNION_CD;
        Initiator_chrsId.value = myresopnse[i].CSU_CHRS_ID;
        break;
    }
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_guideRootPanel_init5
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_guideRootPanel_init5 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployeeAck"){
     showTextErrorModal();
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_chrsId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_chrsId_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_chrsId_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_chrsId_init1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_EmpID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_EmpID_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value == "ToUPD") {
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
mpp_perfromance_evaluation_mpp_performance_evaluation.generated_UPDSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
if(SupportStatement4.value !== null){
...
if(ReviewPeriodFrom.value !== null && ReviewPeriodTo.value !== null){
    ...
    success: function(result) {
        ...
        sheet[0].evalName = "Test - MPP Performance Evaluation";
