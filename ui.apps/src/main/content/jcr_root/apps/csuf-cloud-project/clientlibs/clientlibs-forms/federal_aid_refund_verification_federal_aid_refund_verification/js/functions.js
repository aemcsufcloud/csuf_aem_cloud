...
function singleAidYear() {
    ...
    if (typeOfAidYear == '0') {
        ...
        financialAidYear.value = financialAidYearVal;
        aidYearValue = financialAidYear.value;
        formCode.value = financialAidvalues.FormCodeGeneral + "RFND";
        formCodeVal = financialAidvalues.FormCodeGeneral + "RFND";
        getFAFSAFinancialAidYear(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    }
...
if(cwid.value !== null){
  ...
  EmailSubject.value = "Test - Federal Aid Refund Verification - "+cwid.value;
}

HiddenPanel.HiddenStudentEmail.value="shreyas.manjunatha@thoughtfocus.com";
