...
function getCDAFinancialAidYear(financialAidYear) {
    ...
    var sourceofIncomeText = "<p>Listed below are the sources, amounts of earnings, other income and resources that supported me in the ".concat(taxFilingYear).concat(" tax year. </p>");

    var formTextVal = "<p><b> ".concat(formCodeTextValue).concat(" </b></p>");
  
    Heading.value="(" +financialAidYearVal+ ")"; 
...
function submitAction() {
    if (StageIndicator.value === null) {
        ...
        EmailSubject.value = "Adobe Sign Test - Parent Verification of Non-Filing Letter - " + cwid.value;
    }
   // StudentEmailId.value = "thamizhvanan.sathiyamoorthy@thoughtfocus.com";
   StudentEmailId.value = "yjayaram@fullerton.edu";
    documentNameForAdobeSign.value = "Adobe Sign Test - Parent Verification of Non-Filing Letter - " + formCode.value;
    guideBridge.submit();
}
        }
	}
