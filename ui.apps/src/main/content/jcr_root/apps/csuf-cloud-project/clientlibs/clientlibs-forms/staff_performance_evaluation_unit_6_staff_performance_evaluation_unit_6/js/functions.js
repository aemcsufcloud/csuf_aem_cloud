/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
if(StageIndicator.value == "ToManagerAcknowledge" || StageIndicator.value == "ToManagerFinalAcknowledge" || StageIndicator.value == "ToManagerHRDI" || StageIndicator.value == "ToManagerAcknowledgeOnExpire"){
 basicInformation.enabled = false;
  ...
  EmpSignaturePanel.visible = true;//Eval 2.0 CR
  ...
  signature.visible = false;//Eval 2.0 CR
}else{  
  employeeInformation.enabled = false;
  additionalCriteria.enabled = true;
  comments.enabled = true;
...
if(StageIndicator.value == "ToHRCoo"){
 overallRatingPanel.enabled = false;
  ...
  if(EmpSign.value !== null){
    ...
    if(sendBackStep.value == "From Employee"){
      EmpSignaturePanel.visible = false;//Eval 2.0 CR
        EmpSignaturePanel.enabled = false;
    }else{
    EmpSignaturePanel.visible = false;
    }
...
if(StageIndicator.value == "ToHRDI"){
  employeeInformation.enabled = true;
    ...
    EmpID.enabled = false;
  chrsId.enabled = false;
    StaffLastName.enabled = true;//Eval 2.0 CR
    StaffFirstName.enabled = true;//Eval 2.0 CR
    EmpRCD.enabled = true;
    CBID.enabled = true;
    Range.enabled = true;
	Staffposdesc.enabled = false;
    ...
    EvaluatorsName.enabled = true;//Eval 2.0 CR
    EvaluationType.enabled = true;//Eval 2.0 CR
    ReviewPeriodFrom.enabled = true;//Eval 2.0 CR
    ReviewPeriodTo.enabled = true; //Eval 2.0 CR
overallRatingPanel.enabled = false;
 // employeeInformation.enabled = false;
  additionalCriteria.enabled = false;
  comments.enabled = false;
  ...
  HRSignaturePanel.enabled = true;
   EvaluatorSignaturePanel.visible = true;
  EvaluatorSignaturePanel.enabled = true;//Eval 2.0 CR
  EmpSignaturePanel.visible = true;
  EmpSignaturePanel.enabled = true;//Eval 2.0 CR
   HRCooSection.visible = false;
 //Eval 2.0 CR
...
EmpDate.enabled = false;//Eval 2.0 CR 
   if(AdminSign.value !== null){
     //Eval 2.0 CR
     AdminSignaturePanel.visible = true;
     AdminSignaturePanel.enabled = true;
     ...
     AdminDate.enabled = false;//Eval 2.0 CR
...
/*if(StageIndicator.value == "ToDirector"){
directorSignatureSection.visible = true;
  directorSignatureSection.enabled = true;
  employeeInformation.enabled = false;
  additionalCriteria.enabled = false;
  comments.enabled = false;
  performanceGoalSetting.enabled = false;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){  
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init3
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_guideRootPanel_init3 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployeeAck"){
   showTextErrorModal(); 
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR1_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR1_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR1_click0 = function (scope) {
    with(this) {
        with(scope) {
            /*var flag = 0;
...
function getPdf() {
    ...
    window.guideBridge.getDataXML({
        success: function(result) {
            ...
            jsonData.append('formPath', '/content/forms/af/staff-performance-evaluation-unit-6/staff-performance-evaluation-unit-6');
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CopyRB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CopyRB_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  this.visible = true;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CopyRB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CopyRB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_copyDataPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_copyDataPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_EvalType_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_EvalType_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_ReviewPeriodFrom_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_ReviewPeriodFrom_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_ReviewPeriodTo_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_ReviewPeriodTo_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
   ...
   // if (Copy_EmpId.value !== null && Copy_EvalType.value !== null && Copy_ReviewPeriodFrom.value !== null && Copy_ReviewPeriodTo.value !== null) {
       if (Copy_EmpId.value !== null) {
        if ((CBIDFlag.value !== null) && (CBIDFlag.value == ("M80" || "M98"))) {
            ...
            var actionType = "SPE_UNIT6_COPY_DATA";
            $.ajax({
                type: 'GET',
                url: "/bin/getEvaluationFormData",
                data: {
                ...
                success: function(myresponse) {
                    ...
                    if (myresponse.length === 1) {
                      ...
                      AdditionalCriteria10.value = myresponse[0].ADDCRITERIA_COMMENT_10;*/
                        ...
                        goalOne.value = myresponse[0].PERFORMANCE_GOAL_ONE;
                      	goalTwo.value = myresponse[0].PERFORMANCE_GOAL_TWO;
                        goalThree.value = myresponse[0].PERFORMANCE_GOAL_THREE;
                      	goalFour.value = myresponse[0].PERFORMANCE_GOAL_FOUR;
                        goalFive.value = myresponse[0].PERFORMANCE_GOAL_FIVE;
                      ...
                      AdditionalCriteria10.value = myresponse[n].ADDCRITERIA_COMMENT_10;*/
                        ...
                        goalOne.value = myresponse[n].PERFORMANCE_GOAL_ONE;
                      	goalTwo.value = myresponse[n].PERFORMANCE_GOAL_TWO;
                        goalThree.value = myresponse[n].PERFORMANCE_GOAL_THREE;
                      	goalFour.value = myresponse[n].PERFORMANCE_GOAL_FOUR;
                        goalFive.value = myresponse[n].PERFORMANCE_GOAL_FIVE;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Copy_button_click2 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_init1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_chrsId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpRCD_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpRCD_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CBID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_CBID_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Range_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Range_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StaffFirstName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StaffFirstName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StaffLastName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StaffLastName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    if (this.value !== null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Department_ID_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    if (this.value !== null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Classification_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Classification_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorsName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorsName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorsTitle_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorsTitle_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ReviewPeriodFrom_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ReviewPeriodFrom_init0 = function (scope) {
    with(this) {
        with(scope) {
            /* Add your own JavaScript here. */
if(StageIndicator.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ReviewPeriodTo_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ReviewPeriodTo_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
var dateValue = this.value;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HiddenTextFields_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HiddenTextFields_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_logUser_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_logUser_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpUserID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpUserID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null && this.value === null ){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ManagerUserID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ManagerUserID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StageIndicator_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_StageIndicator_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_divisionName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_divisionName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_division_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_division_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_division_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_division_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SubmissionId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SubmissionId_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  var ID = "";
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_prePerflfEvalPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_prePerflfEvalPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_qualityQuantityOralCommunication_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_qualityQuantityOralCommunication_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quality_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quality_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
    quality1.value = null;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_quality5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__valueCommit00
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__valueCommit00 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Quantity5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OralComm_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OralComm_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "4" || this.value === null) {
   oralCommunicationGroup.visible = false;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OC5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_interpersonalSkillsInitiativeServiceOrientation_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_interpersonalSkillsInitiativeServiceOrientation_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_InterpersonalSkills_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_InterpersonalSkills_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
{
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_IPSkill5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Initiative5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ServiceOrientation_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ServiceOrientation_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value ==="1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value ==="1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value ==="1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value ==="1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SC5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value ==="1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_adaptabilityJobKnowledgeDependabilityReliability_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_adaptabilityJobKnowledgeDependabilityReliability_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Adaptability5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JobKnowledge_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JobKnowledge_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_JK5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DependReli_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DependReli_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
              if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
              if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
              if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
              if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DR5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
              if(this.value == "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_writtenCommunicationProblemSolvingetc_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_writtenCommunicationProblemSolvingetc_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WrittenComm_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WrittenComm_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value === "4" || this.value === null) {
   writtenComGroup.visible = false;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
   {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
   {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
   {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
   {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_WC5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
   {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSolving_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSolving_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ProbSol5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadingOthers_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadingOthers_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_LeadOthers5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "4" || this.value === null)
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
 {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
 {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
 {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
 {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Accepting5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
             if(this.value === "1")
 {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AddCriteriaImpToPos1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AddCriteriaImpToPos1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "4" || this.value === null) {
    AddCriteria1.value = "";
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria1Group_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria1Group_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional5_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_Additional5_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value === "1")
  {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria2Group_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_additionalCriteria2Group_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated__click0 = function (scope) {
    with(this) {
        with(scope) {
            var value;
var rating;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OverallRating_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_OverallRating_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_averageRating_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_averageRating_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployee" || StageIndicator.value == "ToEmployeeAck" || StageIndicator.value == "ToEmployeeAckOnExpire"){
  this.visible = false;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supDocuments_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supDocuments_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  this.enabled = true;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_selfEvalSupDocsPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_selfEvalSupDocsPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible =false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_instanceId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_instanceId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
 if(this.value !== null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_workflowinstanceId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_workflowinstanceId_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value !== null){
 if(this.value !== null){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supDocsGuideText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supDocsGuideText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
  this.visible = true;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_supportDoc4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ExpireText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_ExpireText_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SignedText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SignedText_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DidNotSignText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_DidNotSignText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToManagerFinalAcknowledge"){
  if(EmpCB.value == "1"){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDidNotSignCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDidNotSignCB_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDidNotSignCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDidNotSignCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SendForEmpAckCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SendForEmpAckCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
/*if(StageIndicator.value == "ToManagerAcknowledgeOnExpire"){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SendForEmpAckCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_SendForEmpAckCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToManagerAcknowledgeOnExpire"){
  if(this.value == "1"){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_actionTakenAfterExpiry_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_actionTakenAfterExpiry_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_actionTakenAfterExpiry_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_actionTakenAfterExpiry_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToManagerAcknowledgeOnExpire"){
  if(this.value == "1"){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvalCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvalCB_init0 = function (scope) {
    with(this) {
        with(scope) {
...
if(EvalCB.value !== null){  
  ...
  document.getElementById("guideContainer-rootPanel-panel_2065697473-panel_475955468-signature-panel_2048390334_cop-EvalCB1563954062264___guide-item").childNodes[0].nextSibling.childNodes[1].childNodes[1].childNodes[1].childNodes[2].nextSibling.childNodes[1].innerHTML = item;
  }
}
        }
	}
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvalCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvalCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value === null || StageIndicator.value == "ToManager" || StageIndicator.value == "ToManagerAcknowledge" || StageIndicator.value == "ToManagerFinalAcknowledge" || StageIndicator.value == "ToManagerHRDI" || StageIndicator.value == "ToManagerAcknowledgeOnExpire") {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EvaluatorComment_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCooCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCooCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value == "ToHRCoo") {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCoordinatorSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCoordinatorSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCoordinatorSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRCoordinatorSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployeeAckOnExpire" || StageIndicator.value == "ToEmployeeAck"){
  /*this.mandatory = "";
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == "1") {
  debugger;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpCB_1_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployeeAckOnExpire" || StageIndicator.value == "ToEmployeeAck"){
  if(this.value == "1"){
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_empActionRB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_empActionRB_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_textdraw_10127269701686824008133_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_textdraw_10127269701686824008133_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployee"){
  this.visible = true;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_empHelpText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_empHelpText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployee"){
  this.visible = true;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_rebuttalMessage_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_rebuttalMessage_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToEmployeeAck" || StageIndicator.value == "ToEmployeeAckOnExpire"){
  this.visible = true;  
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_EmpComment_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value == "ToAdmin") {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_AdminComment_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDICB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDICB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 1) {
    if (StageIndicator.value == "ToHRDI") {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIInitials_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIInitials_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIOverallRate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_HRDIOverallRate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_textdraw1686823477242_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_textdraw1686823477242_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToManager" || StageIndicator.value == "ToManagerAcknowledge" || StageIndicator.value == "ToManagerFinalAcknowledge" || StageIndicator.value == "ToManagerHRDI" || StageIndicator.value == "ToManagerAcknowledgeOnExpire" || StageIndicator.value == "ToEmployee" || StageIndicator.value == "ToEmployeeAck" || StageIndicator.value == "ToEmployeeAckOnExpire" || StageIndicator.value == "ToHRDI"){
  this.visible = false;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_generateDOR_click0 = function (scope) {
    with(this) {
        with(scope) {
            /*var flag = 0;
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_reset1561458303307_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_reset1561458303307_click0 = function (scope) {
    with(this) {
        with(scope) {
            EmpID.value = "";
EmpRCD.value = "";
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_saveguidedraft1561458314740_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_saveguidedraft1561458314740_click0 = function (scope) {
    with(this) {
        with(scope) {
            if(EmpID.value !== null){
      ...
      aftiaDescCWID.value = (StaffFirstName.value + " " + StaffLastName.value + " " + EmpID.value+" "+ evalType);
...
/**
 * @function staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_submit1561458295099_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
staff_performance_evaluation_unit_6_staff_performance_evaluation_unit_6.generated_submit1561458295099_click0 = function (scope) {
    with(this) {
        with(scope) {
...
if (flag === 0 && AddCriteriaImpToPos1.value !== "4" && AddCriteriaImpToPos1.value !== null) {
 ...
 if(flag === 0 && supportFactorComments2.value !== null){
  ...
  if(/^(?!\s*$)[\s\S]*$/.test(val)){
    ...
    guideBridge.setFocus(guide[0].guide1[0].guideRootPanel[0].formPanel[0].TabsOnLeftSection[0].performanceGoalSetting[0].performanceGoalComment2[0]);
            flag = 1;
  }
}
//End
/*if(flag=== 0){
  if((supportFactorComments1.value === null || supportFactorComments2.value === null || performanceGoalComment1.value === null || performanceGoalComment2.value === null || goalOne.value === null || goalTwo.value === null || goalThree.value === null || goalFour.value === null || goalFive.value === null)){
   ...
   window.guideBridge.getDataXML({
    success: function(result) {
       // console.log("in view pdf=" + result.data);
        ...
        sheet[0].formPath = "/content/forms/af/staff-performance-evaluation-unit-6/staff-performance-evaluation-unit-6";
        sheet[0].submissionId = SubmissionId.value;
        sheet[0].evalName = "Staff Performance Evaluation Unit 6";
