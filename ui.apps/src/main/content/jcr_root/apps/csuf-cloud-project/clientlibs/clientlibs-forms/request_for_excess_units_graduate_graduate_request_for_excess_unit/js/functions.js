                        ...
                        if (response.length === 1) {
                            if (response[0].ACAD_CAREER == "PBAC") {
                               ...
                               // grad_email.value = response[0].PREF_EMAIL;
                                grad_email.value = "yjayaram@fullerton.edu";
...
function getChairData(deptId) {
    ...
    hidden_chair_userID.value = "admin";
    hidden_chair_name.value = "Administrator";
	//hidden_chair_email.value = "csuf@fullerton.edu";
            hidden_chair_email.value = "yjayaram@fullerton.edu";
  }
        }
    });
...
if (StageIndicator.value == "ToAdvisor" || StageIndicator.value == "ToARSC" || StageIndicator.value === null || StageIndicator.value == "ToChair") {
    if(this.value == "Summer 2022"){
    spring_semester.items = "1 = Summer Semester 20";
    spring_semester.value = 1;
    }
    if(this.value == "Spring 2022"){
    spring_semester.items = "1 = Spring Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Fall 2022"){
    spring_semester.items = "1 = Fall Semester 20";
    spring_semester.value = 1;
    }
  ...
  if(this.value == "Summer 2023"){
    spring_semester.items = "1 = Summer Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Fall 2023"){
    spring_semester.items = "1 = Fall Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Spring 2024"){
    spring_semester.items = "1 = Spring Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Summer 2024"){
    spring_semester.items = "1 = Summer Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Fall 2024"){
    spring_semester.items = "1 = Fall Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Spring 2025"){
    spring_semester.items = "1 = Spring Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Summer 2025"){
    spring_semester.items = "1 = Summer Semester 20";
    spring_semester.value = 1;
    }
  if(this.value == "Fall 2025"){
    spring_semester.items = "1 = Fall Semester 20";
    spring_semester.value = 1;
    }
}
...
/**
 * @function request_for_excess_units_graduate_graduate_request_for_excess_unit.generated_term_description_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
request_for_excess_units_graduate_graduate_request_for_excess_unit.generated_term_description_init1 = function (scope) {
    with(this) {
        with(scope) {
            var term = this.value;
if(term.includes("Winter")){
  WinterAdditionalTab.visible = true;
NonWinterAdditionalTab.visible = false;
}else{
  WinterAdditionalTab.visible = false;
NonWinterAdditionalTab.visible = true;
}
        }
	}
}
...
function submitAction(){
	...
	EmailSubject.value = "Test - Request of Excess Units (Graduate) - " + grad_CWID.value;
