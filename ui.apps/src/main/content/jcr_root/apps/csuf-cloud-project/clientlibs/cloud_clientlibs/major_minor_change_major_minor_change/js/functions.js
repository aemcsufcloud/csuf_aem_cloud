...
if (StageIndicator.value === null){  	
    ...
    DropCurrentMajorRecordsSignaturePanel.visible = false; //Current major drop
  ...
  //DropCurrentMajorCHK.value !== null for to drop current major, drop current major - incase of ToChairNewMajor, panel should be disabled
  		if(DropCurrentMajorCHK.value !== null){     
          	currentMajorDropPanel.enabled = false;
   			ChangeCurrentMajorToNewMajorPanel.visible = true;
        }else{
          	currentMajorDropPanel.visible = false;
          	DropCurrentMajorRecordsSignaturePanel.visible = false;
        }
      // end
  ...
  if(DropCurrentMajorCHK.value !== null){
          	currentMajorDropPanel.enabled = false;         	
          	DropCurrentMajorRecordsSignaturePanel.visible = true;
    		ChangeCurrentMajorToNewMajorPanel.visible = true;
    		ChangeCurrentMajorToNewMajorSignaturePanel.enabled = false;
      		CurrentMajorToNewMajorPanel.enabled = false;
        }else{
    ...
    if(ChangeCurrentMajorToNewMajorSignaturePanel.visible === false){
			...
			$.ajax({
				...
				success: function(myresponse){
                 ...
                 // var userValue = 'm-guiditta';
                 // var userValue = 'yrosas3';
                  //var userValue = 'nathanlee_1';
                  //2 major
                  var userValue = 'emily.bernheim'; 
                //  minor
                // var userValue = 'elykelley'; 
...
/**
 * @function major_minor_change_major_minor_change.generated_guideRootPanel_init3
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_guideRootPanel_init3 = function (scope) {
    with(this) {
        with(scope) {
...
//DropCurrentMajorCHK.value !== null for to drop current major
  	if(AddSecondMajorCHK.value !== null || ChangeAdditionalMajorCHK.value !== null || DropSecondMajorCHK.value !== null || DropCurrentMajorCHK.value !== null){
      	DoubleMajors.visible = true;
      ...
      //drop current major - incase of ToChairNewMajor, panel should be disabled
      if(DropCurrentMajorCHK.value !== null){
          	currentMajorDropPanel.enabled = false;
        }else{
          	currentMajorDropPanel.visible = false;
...
// added DropCurrentMajorCHK.value !== null to drop current major
  	if(AddSecondMajorCHK.value !== null || ChangeAdditionalMajorCHK.value !== null || DropSecondMajorCHK.value !== null || DropCurrentMajorCHK.value !== null){
      	DoubleMajors.visible = true;
...
// DropCurrentMajorCHK.value !== null to drop current major
  	if(AddSecondMajorCHK.value !== null || ChangeAdditionalMajorCHK.value !== null || DropSecondMajorCHK.value !== null || DropCurrentMajorCHK.value !== null){
      	DoubleMajors.visible = true;
...
major_minor_change_major_minor_change.generated_CurrentMajorToNewMajorCHK_valueCommit0 = function (scope) {
  ...
  DropCurrentMajorCHK.value = null;
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){  
    CurrentMajorToDrop.enabled = true;
    CurrentMajorToNewMajorCHK.value = null;
  	
}else{  
  //  CurrentMajorToDrop.value = "Select Major/Concentration";
    CurrentMajorToDrop.enabled = false;
  	DropCurrentMajorAcadPlanCode.value = null;
}
        }
	}
}
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
if(StageIndicator.value === null){
	...
	if(ChangeCurrentMajorToNewMajorSignaturePanel.visible === false){
        ...
        if(this.value !== null){
				...
				CurrentMajorToDrop.value = HiddenCurrentMajor.value;
          		DropCurrentMajorAcadPlanCode.value = HiddenCurrentMajorAcadCode.value;				
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorCHK_valueCommit2 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
debugger;
                        if(myresponse.length >= 1){                 
							var currentMajorArray = [];
                          for (var i = 0; i < myresponse.length; i++) {
							var item = myresponse[i].CURRENT_MAJOR;
							currentMajorArray.push(item);
							}
             	             CurrentMajorToDrop.items = currentMajorArray.sort(); 
                             CurrentMajorDropDetails.value = JSON.stringify(myresponse);
                          
                          
                          
                        /*    var dropCMajorList = document.querySelector(".dropCMajor-list1 select");

                            var length = dropCMajorList.options.length;					
                            for (i = length; i > 0; i--) {
                              dropCMajorList.options[i] = null;
                            } 
                            for(var i=0; i < myresponse.length; i++){
                              var opt = document.createElement("option");
                              opt.value = myresponse[i].CURRENT_MAJOR;
                              //alert("values are="+opt.value);
                              opt.innerHTML = myresponse[i].CURRENT_MAJOR; 
                              dropCMajorList.appendChild(opt);
                            } */
                          
                          gifModal.style.display = "none";
                        }else{
								showErrorModal("Alert !", "You have not enrolled for any major to drop");
						}
                    }
                });
            ...
            gifModal.style.display = "none";
            CurrentMajorToDrop.value = "Select Current Major"; 
            CurrentMajorToDrop.enabled = false;
			DropCurrentMajorAcadPlanCode.value = null;
          	DropCurrentMajorAcadPlanCode.enabled = false;
        }
}
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorToDrop_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorToDrop_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_CurrentMajorToDrop_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_CurrentMajorToDrop_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
    var gifModal = document.getElementById('gifModal');
...
debugger;
                        if(myresponse.length > 0){
                            DropCurrentMajorAcadPlanCode.value = myresponse[0].ACAD_PLAN;    
                        }
						   ...
						   data:  {                      
							...
							success: function(myresponse){
                              debugger;
									...
									//	HiddenChairEmailDropCurrentMajor.value = myresponse[0].CHAIR_EMAIL;
                                        HiddenChairEmailDropCurrentMajor.value = "soumya.ravindra@thoughtfocus.com";
										HiddenChairUserIDDropCurrentMajor.value = myresponse[0].CHAIR_USERID;
										HiddenChairNameDropCurrentMajor.value = myresponse[0].CHAIR_EMPNAME;
										HiddenDepartmentIDDropCurrentMajor.value = myresponse[0].DEPTNAME;
										HiddenDepartmentNameDropCurrentMajor.value = myresponse[0].DEPTID;
                                      	HiddenCollegeCodeDropCurrentMajor.value = myresponse[0].FUL_COLLEGE;
									}
							}
						}); // end 1st ajax	
					  }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorAcadPlanCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorAcadPlanCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToRecords"){
	if(this.value == 1){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsBy_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
major_minor_change_major_minor_change.generated_DropCurrentMajorRecordsBy_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
HiddenMinorChairEmailAddress.value = testEmail;
HiddenCertificateChairEmailAddress.value = testEmail;
HiddenChairEmailDropCurrentMajor.value = testEmail; // current drop major
...
/* To drop current major */
else if(DropCurrentMajorCHK.value !== null && (CurrentMajorToDrop.value === null || CurrentMajorToDrop.value === 'Select Current Major')){	guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].MajorMinorActions[0].ChangeCurrentMajorToNewMajorPanel[0].CurrentMajorToNewMajorPanel[0].currentMajorDropPanel[0].CurrentMajorToDrop[0]");
  	showErrorModal("Field Name: Drop Current Major/Concentration on Tab (A)","Please select Current Major");  	
}
...
//to drop current major
if(DropCurrentMajorCHK.value == "1"){
	globalValue = globalValue + "Dropping a Current Major - " + CurrentMajorToDrop.value + " (" +DropCurrentMajorAcadPlanCode.value + " ), ";
}
