...
/**
 * @function veteran_status_verification_veteran_status_verification.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
veteran_status_verification_veteran_status_verification.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            var flag;
if (StageIndicator.value === null) {
...
function aidYearPopup() {
    ...
    document.getElementById("button1").onclick = function() {
        ...
        aidYearValue = financialAidYear.value;
        if (formType.value == "FAFSA") {
            formCode.value = financialAidvalues.FinAidYearFormCodeOne + "D214";
            formCodeVal = financialAidvalues.FinAidYearFormCodeOne + "D214";
        }
        if (formType.value == "CDA") {
            formCode.value = financialAidvalues.FinAidYearFormCodeOne + "C214";
            formCodeVal = financialAidvalues.FinAidYearFormCodeOne + "C214";
        }
        textChanger(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    ...
    document.getElementById("button2").onclick = function() {
        ...
        aidYearValue = financialAidYear.value;
        if (formType.value == "FAFSA") {
            formCode.value = financialAidvalues.FinAidYearFormCodeTwo + "D214";
            formCodeVal = F1financialAidvalues.FinAidYearFormCodeTwo + "D214";
        }
        if (formType.value == "CDA") {
            formCode.value = financialAidvalues.FinAidYearFormCodeTwo + "C214";
            formCodeVal = F1financialAidvalues.FinAidYearFormCodeTwo + "C214";
        }
        textChanger(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    };
...
function singleAidYear() {
    ...
    if (typeOfAidYear == '0') {
        ...
        aidYearValue = financialAidYear.value;
        if (formType.value == "FAFSA") {
            formCode.value = financialAidvalues.FormCodeGeneral + "D214";
            formCodeVal = financialAidvalues.FormCodeGeneral + "D214";
        }
        if (formType.value == "CDA") {
            formCode.value = financialAidvalues.FormCodeGeneral + "C214";
            formCodeVal = financialAidvalues.FormCodeGeneral + "C214";
        }
        textChanger(aidYearValue);
        checkforDuplicateSubmissions(formCodeVal, financialAidYearVal);
    }
...
/**
 * @function veteran_status_verification_veteran_status_verification.generated_Date_1_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
veteran_status_verification_veteran_status_verification.generated_Date_1_init1 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if(StageIndicator.value === null){
