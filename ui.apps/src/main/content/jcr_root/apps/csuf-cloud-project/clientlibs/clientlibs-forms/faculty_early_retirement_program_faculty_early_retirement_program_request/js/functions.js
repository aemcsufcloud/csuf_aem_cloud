                    ...
                    $.ajax({
                        ...
                        success: function(myresponse) {
                            ...
                            if (myresponse.length === 1) {
                              ...
                              FacultyEmail.value = "chaitanya.sai@thoughtfocus.com";
       ...
       debugger;
            $.ajax({
                ...
                success: function(myresopnse) {
                  ...
                  InitiatorEmail.value = "chaitanya.sai@thoughtfocus.com";
                },
                error: function(error) {
                    alert("error block=" + error);
                }
...
EmailSubject.value = "Test - Faculty Early Retirement Program Request - "+FacultyLastName.value+", "+FacultyFirstName.value;
