...
/**
 * @function personnel_file_access_request_personnel_file_access_request_form.generated_guideRootPanel_init3
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
personnel_file_access_request_personnel_file_access_request_form.generated_guideRootPanel_init3 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_init1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value !== null) {
  this.enabled = false;
...
/**
 * @function personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
personnel_file_access_request_personnel_file_access_request_form.generated_chrsId_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
  ...
  if(CHRSID !== null){
        ...
        gifModal.style.display = "block";
  		$.ajax({
				 type: 'GET',
						url: "/bin/chrsIDUpdateServlet",
						data: {action: "PER_FILE_CHRSID_DATA",chrsId:CHRSID},
						dataType: 'json',
						success: function(myresponse) {
...
personnel_file_access_request_personnel_file_access_request_form.generated_submit1588669558668_click0 = function (scope) {
    with(this) {
        with(scope) {
            aftiaDescCWID.value = (First_Name.value + " " + Last_Name.value + " " + Empl_ID.value);
EmailSubject.value = "Test - Request for Personnel File Access - Staff/Management - " + chrsId.value;
