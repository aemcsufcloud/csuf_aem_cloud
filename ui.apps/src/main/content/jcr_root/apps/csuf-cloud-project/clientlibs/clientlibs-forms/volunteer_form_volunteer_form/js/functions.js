               ...
               scwid.value = response[0].EMPLID;
                   ...
                   State.value = response[0].STATE;
                    ...
                    PhoneNumber.value = response[0].WORK_PHONE;
              		ContactName.value = response[0].EMERGENCY_CONTACT_NAME;
              		ContactNumber.value = response[0].EMERGENCY_PHONE;               
                 //   VolunteerEmail.value = "csufaemform@gmail.com";
               		VolunteerEmail.value = "mepacheco@FULLERTON.EDU";
               ...
               scwid.value = response[0].EMPLID;
                   ...
                   State.value = response[0].STATE;
                    ...
                    PhoneNumber.value = response[0].HOME_PHONE;
                     VolunteerEmail.value = "lpogge@fullerton.edu";
...
function getStudentDetails(userValue) {
    $.ajax({
        ...
        url: "/bin/getVolunteerData",
        data: {
            action: "VOLUNTEER_STUDENT_DETAILS",
            userID: userValue
        },
        dataType: 'json',
        success: function(response) {
...
/**
 * @function volunteer_form_volunteer_form.generated_CSUFstudent_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CSUFstudent_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_18677962761782834496361_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_18677962761782834496361_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_AcademicCredit_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_AcademicCredit_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_CSUFEmployee_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CSUFEmployee_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_2969402881782836731117_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_2969402881782836731117_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_WorkSupervisorName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_WorkSupervisorName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_WorkSupervisorExt_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_WorkSupervisorExt_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_12553088181782837394455_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_12553088181782837394455_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_YesCB1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_YesCB1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToRiskManagement") 
{
...
volunteer_form_volunteer_form.generated_YesCB1_valueCommit2 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if (StageIndicator.value === null) {
  //|| StageIndicator.value == "ToDepartmentCoordinator" || StageIndicator.value == "ToRiskManagement"){
if(this.value == "1"){
...
/**
 * @function volunteer_form_volunteer_form.generated_newLink_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_newLink_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_newLink_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_newLink_init1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_riskmanagementtext_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_riskmanagementtext_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_riskmanagementtext_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_riskmanagementtext_init1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_riskmanagementtext_init00
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_riskmanagementtext_init00 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_ReqSupervisorsName_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_ReqSupervisorsName_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_ReqSupervisorsExt_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_ReqSupervisorsExt_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
this.visible = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_DeptName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_DeptName_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if(StageIndicator.value === null){
...
/**
 * @function volunteer_form_volunteer_form.generated_StartDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_StartDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if(StageIndicator.value === "ToSupervisor"){
...
/**
 * @function volunteer_form_volunteer_form.generated_EndDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EndDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if(StageIndicator.value == "ToSupervisor"){
...
/**
 * @function volunteer_form_volunteer_form.generated_AutoSUVCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_AutoSUVCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_AutoSUVCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_AutoSUVCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
...
/**
 * @function volunteer_form_volunteer_form.generated_VanPCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_VanPCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_VanPCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_VanPCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
...
/**
 * @function volunteer_form_volunteer_form.generated_VanPCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_VanPCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_AutoCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_AutoCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_SUVCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SUVCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_SUVCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SUVCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_CartCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CartCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_OlliTrolleyCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_OlliTrolleyCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_StateCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_StateCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_PersonalCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_PersonalCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_BucketCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_BucketCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
...
/**
 * @function volunteer_form_volunteer_form.generated_BucketCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_BucketCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if ((SupervisorNoCB.value == "2") && (AutoSUVCB.value === null && VanPCB.value === null && AutoCB.value === null && SUVCB.value === null && CartCB.value === null && OlliTrolleyCB.value === null && StateCB.value === null && PersonalCB.value === null && BucketCB.value === null)){
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_OCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_OCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_OCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_OCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "2"){
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_123_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_123_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_Occupants_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_Occupants_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_RoadNoCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_RoadNoCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_RoadNoCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_RoadNoCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "2"){
 // SupervisorNoCB2.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw_15224519331694685_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw_15224519331694685_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function volunteer_form_volunteer_form.generated_AutoclavesCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_AutoclavesCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_BloodCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_BloodCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_CentrifugeCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CentrifugeCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_ChemicalsCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_ChemicalsCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_CompressedCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CompressedCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_CryoCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CryoCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_CryoCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_CryoCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_DCMCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_DCMCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_DCMCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_DCMCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_FormalCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_FormalCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_LasersCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_LasersCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_PaintsCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_PaintsCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_PaintsCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_PaintsCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_PowerCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_PowerCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_PowerCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_PowerCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_RadiationCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_RadiationCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_SawsCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SawsCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_SawsCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SawsCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_SharpsCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SharpsCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_WorkCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_WorkCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == "1"){
  NoneOfTheAbove.value = null;
...
/**
 * @function volunteer_form_volunteer_form.generated_WorkCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_WorkCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null  ){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_SupervisorOtherCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SupervisorOtherCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function volunteer_form_volunteer_form.generated_NoneOfTheAbove_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_NoneOfTheAbove_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(NoneOfTheAbove.value === null && RadiationCB.value === null && LasersCB.value === null && ChemicalsCB.value === null && BloodCB.value === null && SharpsCB.value === null && AutoclavesCB.value === null && CentrifugeCB.value === null && CompressedCB.value === null && FormalCB.value === null && SupervisorOtherCB.value === null && CryoCB.value === null && DCMCB.value === null && PaintsCB.value === null && PowerCB.value === null && SawsCB.value === null && WorkCB.vale === null){
  showErrorModal("Alert !", "Please Select one of the Checkbox to indicate whether the volunteer will work with any of the following");
...
/**
 * @function volunteer_form_volunteer_form.generated_textdraw1733392156092_copy_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_textdraw1733392156092_copy_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value == "ToSupervisor"){
  this.visible = true;
...
/**
 * @function volunteer_form_volunteer_form.generated_supportDoc1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_supportDoc1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_supportDoc2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_supportDoc2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_supportDoc3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_supportDoc3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_VolunteerSdate_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_VolunteerSdate_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
...
/**
 * @function volunteer_form_volunteer_form.generated_Training_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_Training_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if (this.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_driving_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_driving_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if (this.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_Minor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_Minor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if (this.value === null) {
...
volunteer_form_volunteer_form.generated_RiskCB_valueCommit0 = function (scope) {
    with(this) {
        ...
        // Set focus to the Training field (adjust the selector if needed)
        guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].MainPanel[0].SignatureACK[0].RiskManagementPanel[0].Training[0]");
...
/**
 * @function volunteer_form_volunteer_form.generated_RiskCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_RiskCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if (VolunteerSdate.value === null && Training.value === null && driving.value === null && Minor.value === null) {
...
/**
 * @function volunteer_form_volunteer_form.generated_RiskCB_valueCommit2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_RiskCB_valueCommit2 = function (scope) {
    with(this) {
        with(scope) {
            // Assuming fields are named VolunteerSdate, Training, driving, and Minor in the AEM form
debugger;
var VolunteerSdateField = document.getElementById("VolunteerSdate");
var TrainingField = document.getElementById("Training");
var drivingField = document.getElementById("driving");
var MinorField = document.getElementById("Minor");
...
// Handle the case where `this.value == 1` (AJAX request when this.value is 1)
debugger;
//validateFields();
if (this.value == 1) {
    // Ensure validation before proceeding
    if (StageIndicator.value == "ToRiskManagement") {
        if (RiskDate.value === "" || RiskDate.value === null) {
            RiskDate.enabled = false;
            ...
            $.ajax({
                ...
                success: function (myresponse) {
                    ...
                    RiskPrintName.value = userValue;
                    RiskSignature.value = userValue;
                    RiskDate.value = myresponse[0].SERVER_DATE;
                },
                error: function (error) {
                    alert("Error block=" + error);
                }
    ...
    // Reset Risk fields if `this.value` is not 1
    RiskPrintName.value = "";
    RiskSignature.value = "";
    RiskDate.value = "";
}
...
/**
 * @function volunteer_form_volunteer_form.generated_deanLastName_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_deanLastName_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === "ToDepartmentCoordinator") {
...
/**
 * @function volunteer_form_volunteer_form.generated_SupervisorCB_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_SupervisorCB_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === "ToSupervisor") {
...
volunteer_form_volunteer_form.generated_formTitle_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.value = "CSUF Volunteer Form";
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_Supervisor_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_Supervisor_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form – Supervisor Review"+ "" +fname.substring(0, 1)+ "." +lastName.value;
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_DeptCo_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_DeptCo_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form – Dept. Coordinator Review ("+ "" +fname.substring(0, 1)+ "." +lastName.value+ ")";
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_Chair_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_Chair_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form – Dept. Chair Review"+ "" +fname.substring(0, 1)+ "." +lastName.value;
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_Dean_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_Dean_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form – Dean/MPP Designee Review"+ "" +fname.substring(0, 1)+ "." +lastName.value;
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_RiskManagement_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_RiskManagement_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form – Risk Management Review"+ "" +fname.substring(0, 1)+ "." +lastName.value;
        }
	}
}
/**
 * @function volunteer_form_volunteer_form.generated_EmailSubject_Reject_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
volunteer_form_volunteer_form.generated_EmailSubject_Reject_init0 = function (scope) {
    with(this) {
        with(scope) {
            var fname = firstName.value;
this.value = "CSUF Volunteer Form Approval"+ "" +fname.substring(0, 1)+ "." +lastName.value;
...
/*else if(CSUFStudentCB.value === null && CSUFFacultyCB.value === null && CSUFStaffCB.value === null && OtherCB.value === null){
  ...
  showErrorModal("Alert !", "Please ensure that the following required fields are completed: 1. Do you have a Campus Wide Identification Number (CWID)? || 2. Have you ever been convicted of or charged with a crime? || 3. Are you 18 years of age or older? || 4. Have you volunteered at CSUF in the past?");
