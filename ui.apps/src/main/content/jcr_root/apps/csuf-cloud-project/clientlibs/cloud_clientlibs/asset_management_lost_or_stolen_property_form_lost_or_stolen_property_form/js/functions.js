...
/**
 * @function asset_management_lost_or_stolen_property_form_lost_or_stolen_property_form.generated_Date_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
asset_management_lost_or_stolen_property_form_lost_or_stolen_property_form.generated_Date_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null || StageIndicator.value == "ToInitiator") {
    this.enabled = false;
...
/**
 * @function asset_management_lost_or_stolen_property_form_lost_or_stolen_property_form.generated_LastName_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
asset_management_lost_or_stolen_property_form_lost_or_stolen_property_form.generated_LastName_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === null) {
...
asset_management_lost_or_stolen_property_form_lost_or_stolen_property_form.generated_LostCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            /*if(this.value == "1"){
  StolenCB.value = null;
  StolenCB.enabled = false;
}
else{
  StolenCB.enabled = true;
}*/
...
if(StageIndicator.value === null){
  ...
  EmailSubject.value = "Test - Lost or Stolen Property Form - (" + CWID.value + ")";
