    ...
    $.ajax({
        ...
        success: function(myresopnse) {
            if (myresopnse.length !== 0) {
             ...
             //  EmailID.value = "yjayaram@fullerton.edu"; 
               EmailID.value = "shreyas.manjunatha@thoughtfocus.com"; 
  ...
  if (this.value == 1) {
    ...
    $.ajax({
      ...
      //  PayRollEmail.value = "yjayaram@fullerton.edu";
       PayRollEmail.value = "shreyas.manjunatha@thoughtfocus.com";
...
EmailSubject.value = "Test - Faculty Special Consultant Stipend - " + " " + Unit.value;

/*InitiatorEmail.value = "julnunez@FULLERTON.EDU";
ManagerEmail.value  = "julnunez@FULLERTON.EDU";
EmailID.value = "julnunez@FULLERTON.EDU";
