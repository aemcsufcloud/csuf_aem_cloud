/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init1 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef!== null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value !== null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_withdrawalInstructionButton_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_withdrawalInstructionButton_click0 = function (scope) {
    with(this) {
        with(scope) {
                ...
                if (myresponse.Status == "Success") {
                    ...
                    if (stepRef.value === null) {
                        ...
                        $.ajax({
                            ...
                            url: "/bin/getCourseWithdrawalInfo",
                            ...
                            success: function(myresponse) {
                                ...
                                if (myresponse.COURSES.length >= 1) {
                                 ...
                                 /*   ProgramPlan.value = myresponse.PROGRAM_PLAN;
                                    ...
                                    TermCode.value = "2233";
                                    TermDesc.value = "Spring 2023";*/
                                  
                                    ProgramPlan.value = "Undergraduate";
                                    LastName.value = "Joseph";
                                    FirstName.value ="Anthony";
                                    Email.value = "anjoseph2024@gmail.com";
                                    caseId.value = "123456";
                                    StudentID.value = "ID-034";
                                    Major.value = "Psychology";
                                    DegreeObjective.value = "BA";
                                    AcademicPlan.value = "Psychology";
                                    International_Students.value = "N";
                                    Nursing_Flag.value = "N";
                                    EIP_Flag.value = "N";
                                    TelephoneNo.value = "888-777-666";
                                    //TermCode.value = myresponse.STRM;
                                    //TermDesc.value = myresponse.TERM_DESCR;
                                    TermCode.value = "Spring24";
                                    TermDesc.value = "Spring 2024";
                                  debugger;
                                    ...
                                    CourseRow.instanceManager.removeInstance(rowcount - 1);
                                                                  CourseRow.instanceManager.instances[0].CourseNo.value = "12475";
CourseRow.instanceManager.instances[0].ScheduleNo.value = "25";
CourseRow.instanceManager.instances[0].NumberOfUnits.value = "2";
CourseRow.instanceManager.instances[0].NameOfInstructor.value = "Jack Sparrow";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_withdrawalInstructionButton_click1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_withdrawalInstructionButton_click1 = function (scope) {
    with(this) {
        with(scope) {
            if (studentAgreement.value === '' || studentAgreement.value === null) {
    showErrorModal("Alert!","Please accept that you have read and understood the process of medical and non-medical withdrawal");
...
CourseRow.instanceManager.instances[0].ScheduleNo.value = "25";
CourseRow.instanceManager.instances[0].NumberOfUnits.value = "2";
CourseRow.instanceManager.instances[0].NameOfInstructor.value = "Micheal Bracewell";
  }
}
        }
	}
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value == 2){
  mandatedReport.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit2 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
if (typeOfForm.value == "2") {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit3
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit3 = function (scope) {
    with(this) {
        with(scope) {
             if (stepRef.value === null) {
        debugger;
                        ...
                        $.ajax({
                            ...
                            success: function(myresponse) {
                                ...
                                if (myresponse.COURSES.length >= 1) {
                                    ...
                                    var k;
                                    var rowcountRemoveAll1 = CourseRow.instanceManager.instanceCount;
                                    AllCoursWithdrawRB.value = null;
                                    for (k = 0; k < rowcountRemoveAll1; k++) {
                                       CourseRow.instanceManager.instances[CourseRow.instanceIndex].SelectCB.value = null;
                                        CourseRow.instanceManager.removeInstance(CourseRow.instanceIndex);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit4
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_typeOfForm_valueCommit4 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === null) {
    ProgramPlan.value = "Undergraduate";
...
CourseRow.instanceManager.instances[0].ScheduleNo.value = "25";
CourseRow.instanceManager.instances[0].NumberOfUnits.value = "2";
CourseRow.instanceManager.instances[0].NameOfInstructor.value = "Micheal Brracewell";
  }
        }
	}
}
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_15784959911579170730266_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_15784959911579170730266_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value !== null){
this.visible = false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_13322827001573858742686_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_13322827001573858742686_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
this.visible = false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_headerTextNonMedical_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_headerTextNonMedical_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(typeOfForm.value == "1")
  {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_headerTextMedical_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_headerTextMedical_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(typeOfForm.value == "2")
  {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentHeaderTextMed_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentHeaderTextMed_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
 if(typeOfForm.value == "2")
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentHeaderTextNonMed_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentHeaderTextNonMed_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
 if(typeOfForm.value == "1")
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_instructorHeaderText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_instructorHeaderText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToInstructor"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_chairHeaderText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_chairHeaderText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToChair"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_3521054171565338240535_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw_3521054171565338240535_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === null) {
    this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_helpLinkFaculty_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_helpLinkFaculty_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToInstructor"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_helpLinkChair_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_helpLinkChair_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToChair"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_NonMedicalWithdrawal_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_NonMedicalWithdrawal_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (typeOfForm.value == "1") {
    this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_loadingText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_loadingText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_loadingText_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_loadingText_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_DataUnavailableText_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_DataUnavailableText_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value !== null){
this.visible = false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_noRecordMsgMed_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_noRecordMsgMed_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_noRecordMsgNonMed_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_noRecordMsgNonMed_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_LastName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_LastName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_FirstName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_FirstName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MiddleName_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MiddleName_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentID_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Major_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Major_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_DegreeObjective_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_DegreeObjective_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ProgramPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ProgramPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AcademicPlan_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AcademicPlan_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_hiddenFieldsPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_hiddenFieldsPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_EIP_Flag_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_EIP_Flag_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_International_Students_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_International_Students_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLineARSC_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLineARSC_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_classNumberList_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_classNumberList_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_CourseNumberList_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_CourseNumberList_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_stepRef_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_stepRef_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLine_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLine_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLineMedical_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SubjectLineMedical_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_logUser_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_logUser_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_logUser_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_logUser_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AllCourseWithdrawStatus_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AllCourseWithdrawStatus_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_TermCode_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_TermCode_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_TermDesc_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_TermDesc_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw1557993532501_copy_1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw1557993532501_copy_1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AllCoursWithdrawRB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AllCoursWithdrawRB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === null) {
    debugger;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SelectCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_SelectCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw1580452769677_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_textdraw1580452769677_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Covid19CB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Covid19CB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Circumstances_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_Circumstances_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === null) {
    this.visible =  false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionSecNonMedical_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionSecNonMedical_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment2_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionComment2_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentPetitionSecMedical_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentPetitionSecMedical_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment1_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment1_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment2_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment2_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment3_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment3_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment4_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment4_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment5_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentPetitionMedicalComment5_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
  this.mandatory = "error";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportingDocuments_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportingDocuments_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value !== null){
  this.visible = false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDocPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDocPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null)
  {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supDocErrorMessage_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supDocErrorMessage_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc4_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_supportDoc4_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_mandatedReport_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_mandatedReport_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(typeOfForm.value == 1){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentMedCB_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentMedCB_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(typeOfForm.value == 2){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentMedCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_studentMedCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentSign_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_StudentSign_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === null){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_sentToChairInstruction_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_sentToChairInstruction_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToInstructor"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_instructorCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_instructorCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === "ToInstructor") {
  if(this.value == 1){
    $.ajax({
          ...
          success: function(myresponse) {			  
			...
			InstructorSign.value = "Micheal Bracewell";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorRB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorRB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToInstructor"){
  if(this.value == 2){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendInstructor_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendInstructor_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToInstructor"){
if(this.value == "2"){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorDenialReasons_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorDenialReasons_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorDenialReasons_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorDenialReasons_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToInstructor"){
if(this.value == "4"){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorOtherReason_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorOtherReason_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorSign_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorSign_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToInstructor"){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorNoActionMessage_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_InstructorNoActionMessage_init0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToChair" || stepRef.value == "ToARSC"){
  if(AutoAdvanceFlag.value == "true"){
    this.visible = true;
  }else{
  this.visible = false;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_sentToChairInstruction_init00
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_sentToChairInstruction_init00 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToChair"){
  this.visible = true;
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_chairCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_chairCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === "ToChair") {
  if(this.value == 1){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendChair_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendChair_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToChair"){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendChair_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendChair_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToChair"){
if(this.value == "2"){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairDenialReasons_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairDenialReasons_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairDenialReasons_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairDenialReasons_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value == "ToChair"){
if(this.value == "4"){
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairSign_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairSign_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToChair"){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairOtherReason_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ChairOtherReason_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_medicalCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_medicalCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === "ToMedical") {
  if(this.value == 1){
     $.ajax({
          ...
          success: function(myresponse) {			  
			MedicalReviewerSign.value = "Stephan Louis";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendMedical_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_RecommendMedical_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToMedical"){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MedicalReviewerSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MedicalReviewerSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MedicalReviewerSign_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_MedicalReviewerSign_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(stepRef.value === "ToMedical"){
      //var TzoneDate = new Date().toISOString("en-US", {timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone}).slice(0,10);
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === "ToAthletic") {
  if(this.value == 1)
{    $.ajax({
          ...
          success: function(myresponse) {			  
			...
			AthleticReviewerSign.value = "Jonathan Patrick";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_AthleticReviewerDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (stepRef.value === "ToISS") {
  if(this.value == 1)
{    $.ajax({
          ...
          success: function(myresponse) {			  
            ...
            ISSReviewerSign.value = "Tom Williamson";
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ISSReviewerDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_adminCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_adminCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ARSCSign_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_ARSCSign_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function demo__student_course_withdrawl_student_course_withdrawal_demo.generated_mainSubmit_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
demo__student_course_withdrawl_student_course_withdrawal_demo.generated_mainSubmit_click0 = function (scope) {
    with(this) {
        with(scope) {
            withdrawalInstructions.visible = false;
debugger;
...
//Set email address
Email.value = "yashovardhan.jayaram@thoughtfocus.com";
...
//Set Email Subject
SubjectLine.value = "";
SubjectLine.value = ("Student Course Withdrawal Request - " + StudentID.value);
SubjectLineARSC.value = "";
//SubjectLineARSC.value = ("Student Course Withdrawal - ARSC Review " + StudentID.value);
SubjectLineARSC.value = ("Student Course Withdrawal - ARSC Review " + StudentID.value);
SubjectLineMedical.value = "";
SubjectLineMedical.value = ("Student Course Withdrawal - Medical Review " + StudentID.value);
