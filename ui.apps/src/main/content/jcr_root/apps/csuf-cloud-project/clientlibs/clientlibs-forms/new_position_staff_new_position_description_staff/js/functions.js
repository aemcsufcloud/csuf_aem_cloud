...
new_position_staff_new_position_description_staff.generated_guideRootPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            console.log("stage value from value root panel initialize = " + StageIndicator.value);
...
/**
 * @function new_position_staff_new_position_description_staff.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            console.log("stage value from value root panel initialize = " + StageIndicator.value);
        ...
        $.ajax({
            ...
            success: function(myresopnse) {
                ...
                $.ajax({
                    ...
                    data: {
                        userId: userID,
                        action: "NEW_PD_STAFF_USER_CHRSID"
                    },
                    dataType: 'json',
...
/**
 * @function new_position_staff_new_position_description_staff.generated_UpdatePDCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_UpdatePDCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	ClassificationReviewCHK.value = null;
	InRangeCHK.value = null;
...
/**
 * @function new_position_staff_new_position_description_staff.generated_ClassificationReviewCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_ClassificationReviewCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
...
/**
 * @function new_position_staff_new_position_description_staff.generated_InRangeCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_InRangeCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	UpdatePDCHK.value = null;
...
/**
 * @function new_position_staff_new_position_description_staff.generated_ReassiagnmentCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_ReassiagnmentCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value !== null){
  	UpdatePDCHK.value = null;
...
/**
 * @function new_position_staff_new_position_description_staff.generated_CHRSID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_CHRSID_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function new_position_staff_new_position_description_staff.generated_CHRSID_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_CHRSID_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
new_position_staff_new_position_description_staff.generated_CMSPosition_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            console.log("stage value from value commit of CMS = " + StageIndicator.value);
...
/**
 * @function new_position_staff_new_position_description_staff.generated_clear_admin_InfoCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
new_position_staff_new_position_description_staff.generated_clear_admin_InfoCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
