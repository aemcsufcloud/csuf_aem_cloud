...
if (this.value == 1) {
    if (StageIndicator.value === null || StageIndicator.value == "ToEmployee") {
      if (dateInitiated.value === null) {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        dateInitiated.value = getDateforAdaptiveForm();
...
employee_fee_waiver_employee_fee_waiver_application.generated_chairCB_valueCommit0 = function (scope) {
    ...
    if (StageIndicator.value === "ToChair" ) {
      if (deptchairSignedDate.value === null) {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        deptchairSignedDate.value = getDateforAdaptiveForm();
    ...
    if (StageIndicator.value === "ToDean" ) {
      if (collegeDeanSignedDate.value === null) {
       /* var dateString = new Date().toLocaleString("en-US", {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        collegeDeanSignedDate.value = getDateforAdaptiveForm();
...
employee_fee_waiver_employee_fee_waiver_application.generated_supCB_valueCommit0 = function (scope) {
    ...
    if (StageIndicator.value === "ToSupervisor" ) {
      if (supervisorSignedDate.value === null) {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        supervisorSignedDate.value = getDateforAdaptiveForm();
    ...
    if (StageIndicator.value === "ToAdmin" ) {
      if (administratorSignedDate.value === null) {
       /* var dateString = new Date().toLocaleString("en-US", {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        administratorSignedDate.value = getDateforAdaptiveForm();
    ...
    if (StageIndicator.value === "ToHR" || StageIndicator.value === null ) {
      if (hrSigneddate.value === null) {
       /* var dateString = new Date().toLocaleString("en-US", {
        ...
        var curyearDay = dateObject.getDate();
        var d = (curyear + "-" + curyearMonth + "-" + curyearDay);*/
        hrSigneddate.value = getDateforAdaptiveForm();
...
{		//alert("Hello");
  		showErrorModal("Alert!","Please enter Appointment end date."); 
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].empInformation[0].enddate[0]");
}else if (semester.value === null){ 
  
  		showErrorModal("Alert!","Please select a semester.");  
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].semester[0]");
}else if (year.value === null){ 
  
  		showErrorModal("Alert!","Please select a year.");  
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].year[0]");
}
else if (campus_Attending.value === null){
  
  		showErrorModal("Alert!","Please select CSU Campus of enrollment");
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].campus_Attending[0]");
  
}else if (studentType.value === null){
  
  		showErrorModal("Alert!","Please indicate whether you are a new, continuing, or returning student.");
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].studentType[0]");
}
else if (classStanding.value === null){ 
  
  		showErrorModal("Alert!","Please select Class Standing");
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].classStanding[0]");
  ...
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].approvedPlan[0]");
    
}else if (approvedPlan.value == 1 && major.value === null){
 
  		showErrorModal("Alert !","Major is missing.");
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].schoolRelatedInformation[0].major[0]");
  ...
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].courseInformation[0].comment2[0]");
} else if(wr_Cd1.value == 1 && wr_Cd2.value == 1 && comment2.value !== null){
  
  	showErrorModal("Alert !", "Please remove the explanation added for work related courses");
  guideBridge.setFocus("guide[0].guide1[0].guideRootPanel[0].mainPanel[0].courseInformation[0].comment2[0]");
