...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_SemesterTaken_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_SemesterTaken_init0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === "ToDean") {
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_SemesterTaken_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_SemesterTaken_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNametoSearch_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNametoSearch_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value !== null){
  this.visible = false;
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNametoSearch_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNametoSearch_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if(StageIndicator.value === null){ 
$.ajax({
            ...
            success: function(myresponse) {
              ...
              for(var i=0 ; i<myresponse.length; i++){
                arr.push(myresponse[i].CRSE_NAME+" - "+myresponse[i].CLASS_NBR);
              }
                CourseNameNumber.items = arr;
              }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNameNumber_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNameNumber_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value !== null) {
  this.visible=false;
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNameNumber_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_CourseNameNumber_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === null) {
  var CourseNameNumberVal = CourseNameNumber.value;
  var CourseNameNumberSplitVal= CourseNameNumberVal.split(" - ");
  DeptCourseNo.value = CourseNameNumberSplitVal[1];
}
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_DeptCourseNo_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_DeptCourseNo_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_DeptCourseNo_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_DeptCourseNo_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === "ToAdvisor") {
    $.ajax({
        ...
        $.ajax({
            ...
            success: function(fundApproverResult) {
                if (fundApproverResult.length !== 0) {
                    ...
                    //    var uid = "yjayaram@fullerton.edu";
                        var idItem = i + 1;
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionCoordinatorDecision_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionCoordinatorDecision_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (this.value === "1") {
  PetitionNoActionTab.visible=false;
  PetitionDenyTab.visible=false;
  PetitionNoActionDecision.value = null;
  PetitionDenyDecision.value=null;
  Other_2.value=nulll;
  Other_3.value=null;
} else if (this.value === "2") {
  PetitionNoActionTab.visible=true;
  PetitionDenyTab.visible=false;
  PetitionDenyDecision.value=null;
  Other_3.value=null;
} else if (this.value === "3")  {
  PetitionNoActionTab.visible=false;
  PetitionDenyTab.visible=true;
  PetitionNoActionDecision.value=null;
  Other_2.value=null;
} 
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionNoActionTab_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionNoActionTab_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible=false;
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionNoActionDecision_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionNoActionDecision_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (this.value === "3"){
  Other_2.enabled=true;
  Other_2.mandatory=true;
} else {
  Other_2.enabled=false;
  Other_2.mandatory=false;
  Other_2.value=null;
}
        }
	}
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_Other_2_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_Other_2_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionDenyTab_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionDenyTab_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible=false;
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionDenyDecision_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_PetitionDenyDecision_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (this.value === "2"){
  Other_3.enabled=true;
  Other_3.mandatory=true;
} else {
  Other_3.enabled=false;
  Other_3.mandatory=false;
  Other_3.value=null;
}
        }
	}
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_Other_3_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_Other_3_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function petition_for_general_education_variation_petition_for_general_education_variation.generated_HiddenPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
petition_for_general_education_variation_petition_for_general_education_variation.generated_HiddenPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible=false;
...
petition_for_general_education_variation_petition_for_general_education_variation.generated_submit1600234699256_click0 = function (scope) {
    ...
    EmailSubject.value = "Test - Petition for General Education Variation - (" + cwid.value + ")";
