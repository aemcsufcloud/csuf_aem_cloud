...
/**
 * @function leave_of_absence_leave_of_absence.generated_withdrawalInstructionButton_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_withdrawalInstructionButton_click0 = function (scope) {
    with(this) {
        with(scope) {
        ...
        $.ajax({
            ...
            success: function(myresponse) {
               //// var userValue = myresponse.userId;
                ...
                //var userValue = 'fuyintao';  //Graduate - International
                ...
                //userValue = 'kurtlaiftsw';  //Graduate and International
                userValue = 'vbrunovi';  //Graduate and Non-international
...
/**
 * @function leave_of_absence_leave_of_absence.generated_StudentInformation_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_StudentInformation_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function leave_of_absence_leave_of_absence.generated_typeOfForm_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_typeOfForm_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function leave_of_absence_leave_of_absence.generated_typeOfForm_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_typeOfForm_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function leave_of_absence_leave_of_absence.generated_LeaveOfAbsencePanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_LeaveOfAbsencePanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible = false;
        }
...
/**
 * @function leave_of_absence_leave_of_absence.generated_GraduateTwoSemesterTerm3_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_GraduateTwoSemesterTerm3_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSupportingDocumentsPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSupportingDocumentsPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    this.visible = true;
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSupportingDocument3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocumentsPanel_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocumentsPanel_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
    this.visible = true;
...
/**
 * @function leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument1_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument1_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument2_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument2_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument3_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_NonMedicalSupportingDocument3_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(StageIndicator.value === null){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSignatureCHK_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSignatureCHK_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if(this.value == 1){
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalSignatureCHK_valueCommit1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalSignatureCHK_valueCommit1 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function leave_of_absence_leave_of_absence.generated_MedicalDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_MedicalDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
...
/**
 * @function leave_of_absence_leave_of_absence.generated_submitButton_click0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
leave_of_absence_leave_of_absence.generated_submitButton_click0 = function (scope) {
    with(this) {
        with(scope) {
            
aftiaDescCWID.value = StudentFirstName.value +", " + StudentLastName.value + " " + StudentCWID.value;

EmailSubject.value = "Test - Request for leave of absence - " + StudentCWID.value;
