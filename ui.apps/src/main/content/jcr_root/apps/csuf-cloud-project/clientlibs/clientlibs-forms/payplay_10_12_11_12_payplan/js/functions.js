...
/**
 * @function payplay_10_12_11_12_payplan.generated_CHRSID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
payplay_10_12_11_12_payplan.generated_CHRSID_init0 = function (scope) {
    with(this) {
        with(scope) {
...
/**
 * @function payplay_10_12_11_12_payplan.generated_CHRSID_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
payplay_10_12_11_12_payplan.generated_CHRSID_init1 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value !== null) {
  this.enabled = false;
...
/**
 * @function payplay_10_12_11_12_payplan.generated_dateInitiated_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
payplay_10_12_11_12_payplan.generated_dateInitiated_init1 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
...
var dateString = new Date().toLocaleString("en-US", {
            ...
            var curyearMonth = dateObject.getMonth() + 1;
            var curyearDay = dateObject.getDate();
            var dateInitiatedt = (curyear + "-" + curyearMonth + "-" + curyearDay);
            dateInitiated.value = dateInitiatedt;
        }
	}
}
/**
...
payplay_10_12_11_12_payplan.generated_submit1576718023814_click0 = function (scope) {
  ...
  emailSubject.value = "Test - Request for 10/12 11/12 Pay Plan - " + CHRSID.value;
