...
if(StageIndicator.value == "ToInitiator"){
  ...
  if ((ExceptionType.value == "Articulation Issue") || (ExceptionType.value == "Repeat Adjustment") || (ExceptionType.value == "Transfer Course Evaluation")) {
  ...
  }  else if ((ExceptionType.value == "Add a Course/Courses to a major requirement area") || (ExceptionType.value == "Substitute or Replace a Course on a major requirement") || (ExceptionType.value == "TDA Template Issue") || (ExceptionType.value == "Requirement Waiver/Modification")) {
...
/**
 * @function tda_exception_form_tda_exception_form.generated_guideRootPanel_init2
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_guideRootPanel_init2 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if(StageIndicator.value === null){
  ...
  AdjustmentforGeneralEducationTab.visible=true;
  AdjustmentforGeneralEducationTab.enabled=true;
  AdjustmentforMajorRequirementTab.visible=true;
  AdjustmentforMajorRequirementTab.enabled=true;
  OtherModificationsTab.visible=true;
  OtherModificationsTab.enabled=true;
...
if(StageIndicator.value == "ToATCE"){
  ...
  AdjustmentforGeneralEducationTab.visible=true;
  AdjustmentforGeneralEducationTab.enabled=false;
  AdjustmentforMajorRequirementTab.visible=true;
  AdjustmentforMajorRequirementTab.enabled=false;
  OtherModificationsTab.visible=true;
  OtherModificationsTab.enabled=false;
...
if(StageIndicator.value == "ToOfficeGrad"){
  ...
  InitiatorPanel.enabled=false;
  OfficeGradSignaturePanel.visible=true;
  OfficeGradSignaturePanel.enabled=true;
...
/**
 * @function tda_exception_form_tda_exception_form.generated_CWID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_CWID_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null){
  this.enabled = true;
    ...
    $.ajax({
        ...
        success: function(myresopnse) {
            ...
            if (myresopnse.length === 1 && myresopnse[0].STUDENT_ID !== undefined) {
                ...
                var expectedTerm = myresopnse[0].EXP_GRAD_TERM;
              if(expectedTerm !== null){
                    if (!expectedTerm.trim()) {
     Term.value = "";
} else{
  Term.value = myresopnse[0].EXP_GRAD_TERM;
}
              }else{
                Term.value = "";
              }
                ...
                okButton.onclick = function(event) {
                    ...
                    for (n = 0; n < rButtons.length; n++) {
                        if (rButtons[n].checked === false) {
                            ...
                            //Term.value = myresopnse[n].EXP_GRAD_TERM;
                             var expectedTerm = myresopnse[n].EXP_GRAD_TERM;
              if(expectedTerm !== null){
                    if (!expectedTerm.trim()) {
     Term.value = "";
} else{
...
if (GeneralEducationTDA.instanceManager.instanceCount >= 1 && GeneralEducationTDA.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < GeneralEducationTDA.instanceManager.instanceCount; count++) {
        if ((GeneralEducationTDA.instanceManager.instances[count]._children[0].value === null) || (GeneralEducationTDA.instanceManager.instances[count]._children[1].value === null)) {
...
if (GeneralEducationATCE.instanceManager.instanceCount >= 1 && GeneralEducationATCE.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < GeneralEducationATCE.instanceManager.instanceCount; count++) {
        if ((GeneralEducationATCE.instanceManager.instances[count]._children[0].value === null) || (GeneralEducationATCE.instanceManager.instances[count]._children[1].value === null) || (GeneralEducationATCE.instanceManager.instances[count]._children[2].value === null)) {
            isAddRowAllowed = false;
            showErrorModal("Alert !", "Please Enter the record before adding a new row");
        } else {
            isAddRowAllowed = true;
...
if (MajorReqTDA.instanceManager.instanceCount >= 1 && MajorReqTDA.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < MajorReqTDA.instanceManager.instanceCount; count++) {
        if ((MajorReqTDA.instanceManager.instances[count]._children[0].value === null) || (MajorReqTDA.instanceManager.instances[count]._children[1].value === null) || (MajorReqTDA.instanceManager.instances[count]._children[2].value === null)) {
            isAddRowAllowed = false;
            showErrorModal("Alert !", "Please Enter the record before adding a new row");
        } else {
            isAddRowAllowed = true;
...
if (MajorReqATCE.instanceManager.instanceCount >= 1 && MajorReqATCE.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < MajorReqATCE.instanceManager.instanceCount; count++) {
        if ((MajorReqATCE.instanceManager.instances[count]._children[0].value === null) || (MajorReqATCE.instanceManager.instances[count]._children[1].value === null) || (MajorReqATCE.instanceManager.instances[count]._children[2].value === null) || (MajorReqATCE.instanceManager.instances[count]._children[3].value === null)) {
            isAddRowAllowed = false;
            showErrorModal("Alert !", "Please Enter the record before adding a new row");
        } else {
            isAddRowAllowed = true;
...
if (OtherTDA.instanceManager.instanceCount >= 1 && OtherTDA.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < OtherTDA.instanceManager.instanceCount; count++) {
        if ((OtherTDA.instanceManager.instances[count]._children[0].value === null) || (OtherTDA.instanceManager.instances[count]._children[1].value === null)) {
            isAddRowAllowed = false;
            showErrorModal("Alert !", "Please Enter the record before adding a new row");
        } else {
            isAddRowAllowed = true;
...
if (OtherATCE.instanceManager.instanceCount >= 1 && OtherATCE.instanceManager.instanceCount <= 5) {
    for (var count = 0; count < OtherATCE.instanceManager.instanceCount; count++) {
        if ((OtherATCE.instanceManager.instances[count]._children[0].value === null) || (OtherATCE.instanceManager.instances[count]._children[1].value === null) || (OtherATCE.instanceManager.instances[count]._children[2].value === null)) {
            isAddRowAllowed = false;
            showErrorModal("Alert !", "Please Enter the record before adding a new row");
        } else {
            isAddRowAllowed = true;
...
/**
 * @function tda_exception_form_tda_exception_form.generated_DeanCB_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_DeanCB_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value == "ToDean") {
    if (this.value == 1) {
...
/**
 * @function tda_exception_form_tda_exception_form.generated_DeanSignature_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_DeanSignature_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function tda_exception_form_tda_exception_form.generated_DeanSignDate_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_DeanSignDate_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled=false;
        }
...
/**
 * @function tda_exception_form_tda_exception_form.generated_ATCEDecision_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_ATCEDecision_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.visible=false;
        }
...
tda_exception_form_tda_exception_form.generated_ExceptionType_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            debugger;
if (StageIndicator.value === null) {
    if ((this.value == "Articulation Issue") || (this.value == "Repeat Adjustment") || (this.value == "Transfer Course Evaluation")) {
        ExceptionFlag.value = "ATCE";
    } else if ((this.value == "Add a Course/Courses to a major requirement area") || (this.value == "Substitute or Replace a Course on a major requirement") || (this.value == "TDA Template Issue") || (this.value == "Requirement Waiver/Modification")) {
...
/**
 * @function tda_exception_form_tda_exception_form.generated_textbox1690806213025_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_textbox1690806213025_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null || StageIndicator.value=="ToInitiator" || StageIndicator.value=="ToTDA")  {
    var appResult = [];
    if (this.value !== null) {
        $.ajax({
            type: 'GET',
...
/**
 * @function tda_exception_form_tda_exception_form.generated_DeanDropDown_valueCommit0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
tda_exception_form_tda_exception_form.generated_DeanDropDown_valueCommit0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null || StageIndicator.value=="ToTDA" || StageIndicator.value=="ToInitiator")  {
            ...
            $.ajax({
                ...
                success: function(myresopnse) {
                    if (myresopnse.length !== 0) {
                        ...
                        DeanEmailID.value = "abvega@FULLERTON.EDU";   
                    } else {
                        DeanName.value = "";
                        DeanUserID.value = "";
                        DeanEmailID.value = "";
...
tda_exception_form_tda_exception_form.generated_submit1600234699256_click0 = function (scope) {
  ...
  //  DeanEmailID.value = "thamizhvanan.sathiyamoorthy@thoughtfocus.com";
   ...
   // DeanEmailID.value = "anupama.dhar@thoughtfocus.com";
     FacultyEmail.value = "abvega@FULLERTON.EDU";
     DeanEmailID.value = "abvega@FULLERTON.EDU";
}
guideBridge.submit();
        }
