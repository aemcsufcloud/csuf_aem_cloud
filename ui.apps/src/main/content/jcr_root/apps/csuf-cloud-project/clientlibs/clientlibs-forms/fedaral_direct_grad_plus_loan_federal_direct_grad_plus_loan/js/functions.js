...
/**
 * @function fedaral_direct_grad_plus_loan_federal_direct_grad_plus_loan.generated_guideRootPanel_init3
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
fedaral_direct_grad_plus_loan_federal_direct_grad_plus_loan.generated_guideRootPanel_init3 = function (scope) {
    with(this) {
        with(scope) {
            var flag;
if (StageIndicator.value === null) {
...
function getCDAFinancialAidYear(financialAidYear) {
    ...
    var ApplicationDate2 = "<li>&nbsp;Academic Year processing begins late July deadline - ".concat(ApplicationDate2Change).concat("</li>");
    var ApplicationDate3 = "<li>&nbsp;Spring only loans processing begins early January deadline - ".concat(ApplicationDate3Change).concat("</li>");
    var ApplicationDate4 = "<li>&nbsp;Summer loans processing begins ".concat(ApplicationDate4Change).concat("</li>");
...
/**
 * @function fedaral_direct_grad_plus_loan_federal_direct_grad_plus_loan.generated_Date_1_init1
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
fedaral_direct_grad_plus_loan_federal_direct_grad_plus_loan.generated_Date_1_init1 = function (scope) {
    with(this) {
        with(scope) {
            debugger; 
if(StageIndicator.value === null){
