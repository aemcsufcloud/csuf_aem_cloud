...
/**
 * @function peoplesoft_access_review_form_peoplesoft_access_review_form.generated_cwid_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
peoplesoft_access_review_form_peoplesoft_access_review_form.generated_cwid_init0 = function (scope) {
    with(this) {
        with(scope) {
            if (StageIndicator.value === null) {
  this.enabled=true;
                                ...
                                okButton.onclick = function(event) {
                                    ...
                                    for (n = 0; n < rButtons.length; n++) {
                                        if (rButtons[n].checked === false) {
                                            ...
                                            showRolesTab(DeptID.value);
                                            if (myresponse[n].MANAGER === undefined || myresponse[n].MANAGER === null) {
...
/**
 * @function peoplesoft_access_review_form_peoplesoft_access_review_form.generated_Email_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
peoplesoft_access_review_form_peoplesoft_access_review_form.generated_Email_init0 = function (scope) {
    with(this) {
        with(scope) {
            this.enabled = false;
        }
