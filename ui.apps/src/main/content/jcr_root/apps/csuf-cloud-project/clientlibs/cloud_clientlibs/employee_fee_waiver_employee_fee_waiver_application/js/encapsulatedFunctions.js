...
/**
 * @function employee_fee_waiver_employee_fee_waiver_application.generated_comment2_calc0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 * @returns {string}
 */
employee_fee_waiver_employee_fee_waiver_application.generated_comment2_calc0 = function (scope) {
    with(this) {
        with(scope) {
