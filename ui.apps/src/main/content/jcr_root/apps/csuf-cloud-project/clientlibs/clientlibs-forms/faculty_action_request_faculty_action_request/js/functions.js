...
/**
 * @function faculty_action_request_faculty_action_request.generated_CHRSID_init0
 * @this currentComponent
 * @param {scope} scope in which code inside function will be executed.
 */
faculty_action_request_faculty_action_request.generated_CHRSID_init0 = function (scope) {
    with(this) {
        with(scope) {
    ...
    $.ajax({
      ...
      //  //HRDIExt.value = "academichr@fullerton.edu";
       // HRSignEmailID.value = "academichr@fullerton.edu";
        ...
        // HRSignEmailID.value ="yjayaram@fullerton.edu";
      },
      error: function (error) {
        alert("error block=" + error);
      }
  ...
  if (DeanPrintedName.value === null) {
    ...
    $.ajax({
      ...
      success: function (myresopnse) {
       ...
       //  DeanSignEmailID.value ="yjayaram@fullerton.edu";
      },
      error: function (error) {
        alert("error block=" + error);
      }
...
faculty_action_request_faculty_action_request.generated_DeptChairCB_valueCommit0 = function (scope) {
  ...
  if (DeptChairPrintedName.value === null) {
    ...
    $.ajax({
      ...
      //   ChairSignEmailID.value ="yjayaram@fullerton.edu";
  ...
  if (PayrollSignature.value === null) {
    ...
    $.ajax({
      ...
      //  PayrollSignEmailID.value = "payroll@fullerton.edu";
        ...
        // PayrollSignEmailID.value ="yjayaram@fullerton.edu";
      },
      error: function (error) {
        alert("error block=" + error);
      }
...
if (CWID.value !== null) {
  aftiaDescCWID.value = FirstName.value + " " + LastName.value + " " + CWID.value;
  EmailSubject.value = "Test - Faculty Action Request - " + LastName.value + "," + FirstName.value + " - " + ReportingUnit.value;
}
