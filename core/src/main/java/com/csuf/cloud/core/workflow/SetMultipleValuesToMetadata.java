...
@Component(property = { "service.description=Get Value", "service.vendor=Adobe Systems",
		"process.label=Get Multiple Value of Element in Xml" })
	...
	public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap arg2) throws WorkflowException {
		...
		try {
			...
			for (int j = 0; j < i; ++j) {
				...
				org.w3c.dom.Node node = (org.w3c.dom.Node) xPath.compile(valueOne).evaluate(xmlDocument,
						XPathConstants.NODE);
