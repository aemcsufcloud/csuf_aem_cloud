...
public class CourseWithdrawalReportModel {
	...
	protected void init() {
		try {
			scwReportJsonArray = taskService.getTaskDetailsFromProcessingInstance("/bin/getInboxReport?workflowType=COURSE_WITHDRAWAL");
		} catch (Exception e) {
